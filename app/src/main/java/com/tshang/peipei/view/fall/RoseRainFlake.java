...
public class RoseRainFlake {
	 ...
	 */
	static RoseRainFlake createFlake(Context context, float xRange, float xHeight, Bitmap originalBitmap) {
		RoseRainFlake flake = new RoseRainFlake();
