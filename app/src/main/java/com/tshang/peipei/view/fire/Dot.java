...
public abstract class Dot {
	...
	public Dot(Context context, int color, int y, int endX, int endY) {
		circle = 1;
		state = 1;
		pace = BaseUtils.dip2px(context, 30);
	...
	class loadFireSrc extends Thread {
		public void run() {
			mFireAnim = new Animation(mContext, new int[] { R.drawable.trail1, R.drawable.trail2, R.drawable.trail3, R.drawable.trail4,
