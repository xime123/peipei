...
public class StarFallFlake1 {
	 ...
	 * determined.
	 */
	static StarFallFlake1 createFlake(Context context, float xRange, float yRange, Bitmap originalBitmap, boolean isAlpha) {
		StarFallFlake1 flake = new StarFallFlake1();
		...
		// range
		if (!isAlpha) {
			int size = BaseUtils.dip2px(context, 50);
