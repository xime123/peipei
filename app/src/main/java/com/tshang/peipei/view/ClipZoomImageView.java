...
public class ClipZoomImageView extends LinearLayout implements OnScaleGestureListener, OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener {
	...
	private void init(Context context) {
		View view = LayoutInflater.from(context).inflate(R.layout.clip_img_dynamic_layout, null);
		imageView = (ImageView) view.findViewById(R.id.clip_imagView);
		textView = (TextView) view.findViewById(R.id.clip_textView);
		titleTextView = (TextView) view.findViewById(R.id.img_text_adpter_topic_title_tv);
		this.addView(view);
		mGestureDetector = new GestureDetector(getContext(), new SimpleOnGestureListener() {
			...
			public boolean onDoubleTap(MotionEvent e) {
				...
				if (getScale() < SCALE_MID) {
					ClipZoomImageView.this.post(new AutoScaleRunnable(SCALE_MID, x, y));
					isAutoScale = true;
				} else {
					ClipZoomImageView.this.post(new AutoScaleRunnable(initScale, x, y));
					isAutoScale = true;
				}
	...
	public void setTextColor(int colorRes) {
		...
		titleTextView.setTextColor(colorRes);
		if (getResources().getColor(R.color.white) == colorRes) {
			textView.setShadowLayer(15, 5, 5, getResources().getColor(R.color.black));
			titleTextView.setShadowLayer(15, 5, 5, getResources().getColor(R.color.black));
		} else {
			textView.setShadowLayer(15, 5, 5, getResources().getColor(R.color.white));
			titleTextView.setShadowLayer(15, 5, 5, getResources().getColor(R.color.white));
		}
	}
	...
	public void setImagePath(String path) {
		...
		imageLoader.displayImage("file://" + path, imageView, options, new ImageLoadingListener() {
	...
	public Bitmap clip() {
		...
		draw(canvas);
		return Bitmap.createBitmap(bitmap, mHorizontalPadding, getHVerticalPadding(), getWidth() - 2 * mHorizontalPadding, getWidth() - 2
				* mHorizontalPadding);
	}
