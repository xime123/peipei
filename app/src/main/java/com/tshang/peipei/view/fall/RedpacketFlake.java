...
public class RedpacketFlake {
	 ...
	 * determined.
	 */
	static RedpacketFlake createFlake(Context context, float xRange, Bitmap originalBitmap) {
		RedpacketFlake flake = new RedpacketFlake();
		...
		flake.speed = 200 + (float) Math.random() * 100;
