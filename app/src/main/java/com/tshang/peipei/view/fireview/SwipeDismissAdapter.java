...
public class SwipeDismissAdapter extends BaseAdapterDecorator {
	...
	public void notifyToDismiss(int downPosition, View downView, boolean isRight) {
		mSwipeDismissListViewTouchListener.sendToDismiss(downPosition, downView, isRight);
	}
