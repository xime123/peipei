...
public abstract class ViewScroller {
	...
	public static ViewScroller getScroller(Context context) {
	...
	@TargetApi(9)
	private static class GingerScroller extends ViewScroller {
	...
	private static class PreGingerScroller extends ViewScroller {
