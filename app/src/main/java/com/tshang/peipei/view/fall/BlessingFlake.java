...
public class BlessingFlake {
	 ...
	 * determined.
	 */
	static BlessingFlake createFlake(Context context, float xRange, Bitmap originalBitmap) {
		BlessingFlake flake = new BlessingFlake();
		...
		flake.speed = 50 + (float) Math.random() * 70;
