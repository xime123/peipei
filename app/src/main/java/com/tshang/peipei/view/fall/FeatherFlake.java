...
public class FeatherFlake {
	 ...
	 */
	static FeatherFlake createFlake(Context context, float xRange, float xHeight, Bitmap originalBitmap) {
		FeatherFlake flake = new FeatherFlake();
		// Size each flake with a width between 5 and 55 and a proportional height
		int size = BaseUtils.dip2px(context, 30);
