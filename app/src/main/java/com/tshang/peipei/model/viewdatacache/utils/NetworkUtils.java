 ...
 * @author Jeff  
 *
 * @date 2014年10月8日 下午4:09:30 
 *
 * @version V1.3.0   
 */
public class NetworkUtils {
	public static final String NETWORN_NONE = "networn_none";//没网络状态
	public static final String NETWORN_WIFI = "networn_wifi";//wifi网络
	public static final String NETWORN_3G = "networn_3g";//3g网络
