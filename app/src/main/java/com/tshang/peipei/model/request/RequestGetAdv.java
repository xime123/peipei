 ...
 * @version V1.6.0   
 */
public class RequestGetAdv extends AsnBase implements ISocketMsgCallBack {

	private IGetAdvUrl addblack;

	public void getAdv(Activity activity, IGetAdvUrl addblack) {
		String host = "ppapp.tshang.com";
		if (BAConstants.IS_TEST) {
			host = "pptest.yidongmengxiang.com";
		}

		String url = "/media/getMedias";
