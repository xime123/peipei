...
import com.tshang.peipei.vender.common.service.impl.FileNameRuleImageUrl;
import com.tshang.peipei.vender.common.service.impl.ImageCache;
import com.tshang.peipei.vender.common.service.impl.ImageMemoryCache.OnImageCallbackListener;
import com.tshang.peipei.vender.common.service.impl.ImageSDCardCache;
import com.tshang.peipei.vender.common.service.impl.ImageSDCardCache.OnImageSDCallbackListener;
import com.tshang.peipei.vender.common.service.impl.PreloadDataCache.OnGetDataListener;
import com.tshang.peipei.vender.common.service.impl.RemoveTypeLastUsedTimeFirst;
	...
	public static ImageCache getImageCache() {
		if (imageCache == null) {
			synchronized (CacheManager.class) {
				if (imageCache == null) {
					imageCache = new ImageCache(128, 256);
					setImageCache();
				}
			}
		}
			...
			public void onGetSuccess(String imageUrl, Bitmap loadedImage, View view, boolean isInCache) {
				if (view != null && loadedImage != null) {
					if (view instanceof ImageView) {
						...
						Log.e(TAG, "View is not instance of ImageView, you need to setOnImageCallbackListener() by your self");
					}
				}
			}
		...
		OnImageSDCallbackListener imageCallBack = new OnImageSDCallbackListener() {
			...
			public void onGetSuccess(String imageUrl, String imagePath, View view, boolean isInCache) {
				if (view != null && view instanceof ImageView) {
					...
					Log.e(TAG, "View is not instance of ImageView, you need to setOnImageSDCallbackListener() by your self");
				}
			}
