...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetBroadcastList.java
//
//   Java class for ASN.1 definition ReqGetBroadcastList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetBroadcastList</tt>.
...
public class ReqGetBroadcastList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetBroadcastList() {}

  /** copy constructor */
  public ReqGetBroadcastList (ReqGetBroadcastList arg) {
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
    num = arg.num;
