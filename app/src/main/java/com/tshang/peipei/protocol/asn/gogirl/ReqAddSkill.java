...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqAddSkill.java
//
//   Java class for ASN.1 definition ReqAddSkill as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqAddSkill</tt>.
...
public class ReqAddSkill implements ASN1Type {
  ...
  /** copy constructor */
  public ReqAddSkill (ReqAddSkill arg) {
    uid = arg.uid;
