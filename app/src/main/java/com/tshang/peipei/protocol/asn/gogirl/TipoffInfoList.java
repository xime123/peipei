...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/TipoffInfoList.java
//
//   Java class for ASN.1 definition TipoffInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>TipoffInfoList</tt>.
...
public class TipoffInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public TipoffInfoList() {}

  /** copy constructor */
  public TipoffInfoList (TipoffInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((TipoffInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((TipoffInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((TipoffInfo)(e.nextElement())).print(os, indent+2);
