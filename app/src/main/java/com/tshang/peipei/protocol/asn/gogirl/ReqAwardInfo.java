...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqAwardInfo.java
//
//   Java class for ASN.1 definition ReqAwardInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqAwardInfo</tt>.
...
public class ReqAwardInfo implements ASN1Type {
  ...
  /** copy constructor */
  public ReqAwardInfo (ReqAwardInfo arg) {
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
    num = arg.num;
