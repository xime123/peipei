...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/BanDeviceInfo.java
//
//   Java class for ASN.1 definition BanDeviceInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>BanDeviceInfo</tt>.
...
public class BanDeviceInfo implements ASN1Type {

  /** member variable representing the sequence member bantime of type java.math.BigInteger */
  public java.math.BigInteger bantime;
  ...
  /** default constructor */
  public BanDeviceInfo() {}

  /** copy constructor */
  public BanDeviceInfo (BanDeviceInfo arg) {
    bantime = arg.bantime;
