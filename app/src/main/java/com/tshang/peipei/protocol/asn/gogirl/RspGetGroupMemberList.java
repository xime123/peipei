...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspGetGroupMemberList.java
//
//   Java class for ASN.1 definition RspGetGroupMemberList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetGroupMemberList</tt>.
...
public class RspGetGroupMemberList implements ASN1Type {
  ...
  /** member variable representing the sequence member memberlist of type GroupMemberInfoList */
  public GroupMemberInfoList memberlist = new GroupMemberInfoList();
  /** member variable representing the sequence member isend of type java.math.BigInteger */
  public java.math.BigInteger isend;

  /** default constructor */
  public RspGetGroupMemberList() {}

  /** copy constructor */
  public RspGetGroupMemberList (RspGetGroupMemberList arg) {
    retcode = arg.retcode;
    retmsg = new byte[arg.retmsg.length];
    System.arraycopy(arg.retmsg,0,retmsg,0,arg.retmsg.length);
    maxmembernum = arg.maxmembernum;
    total = arg.total;
    memberlist = new GroupMemberInfoList(arg.memberlist);
    isend = arg.isend;
  }
