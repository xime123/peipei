...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqDeleteDynamics.java
//
//   Java class for ASN.1 definition ReqDeleteDynamics as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqDeleteDynamics</tt>.
...
public class ReqDeleteDynamics implements ASN1Type {
  ...
  /** default constructor */
  public ReqDeleteDynamics() {}

  /** copy constructor */
  public ReqDeleteDynamics (ReqDeleteDynamics arg) {
    uid = arg.uid;
    type = arg.type;
