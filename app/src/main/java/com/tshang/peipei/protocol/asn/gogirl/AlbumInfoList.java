...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/AlbumInfoList.java
//
//   Java class for ASN.1 definition AlbumInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>AlbumInfoList</tt>.
...
public class AlbumInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public AlbumInfoList() {}

  /** copy constructor */
  public AlbumInfoList (AlbumInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((AlbumInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((AlbumInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((AlbumInfo)(e.nextElement())).print(os, indent+2);
