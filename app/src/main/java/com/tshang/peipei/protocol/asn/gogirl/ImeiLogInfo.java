...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ImeiLogInfo.java
//
//   Java class for ASN.1 definition ImeiLogInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ImeiLogInfo</tt>.
...
public class ImeiLogInfo implements ASN1Type {

  /** member variable representing the sequence member imei of type byte[] */
  public byte[] imei;
  /** member variable representing the sequence member loguids of type LogUidList */
  public LogUidList loguids = new LogUidList();
  /** member variable representing the sequence member reguids of type LogUidList */
  public LogUidList reguids = new LogUidList();
  /** member variable representing the sequence member logtime of type java.math.BigInteger */
  public java.math.BigInteger logtime;
  /** member variable representing the sequence member regtime of type java.math.BigInteger */
  public java.math.BigInteger regtime;
  /** member variable representing the sequence member phoneos of type byte[] */
  public byte[] phoneos;
  ...
  /** copy constructor */
  public ImeiLogInfo (ImeiLogInfo arg) {
    imei = new byte[arg.imei.length];
    System.arraycopy(arg.imei,0,imei,0,arg.imei.length);
    loguids = new LogUidList(arg.loguids);
    reguids = new LogUidList(arg.reguids);
    logtime = arg.logtime;
    regtime = arg.regtime;
    phoneos = new byte[arg.phoneos.length];
    System.arraycopy(arg.phoneos,0,phoneos,0,arg.phoneos.length);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    loguids.encode(enc);
    reguids.encode(enc);
    enc.encodeInteger(logtime);
    enc.encodeInteger(regtime);
    enc.encodeOctetString(phoneos);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    loguids.decode(dec);
    reguids.decode(dec);
    logtime = dec.decodeInteger();
    regtime = dec.decodeInteger();
    phoneos = dec.decodeOctetString();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("loguids = ");
    loguids.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("reguids = ");
    reguids.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("logtime = ");
    os.print(logtime.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("regtime = ");
    os.print(regtime.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("phoneos = ");
    os.print(Hex.toString(phoneos));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
