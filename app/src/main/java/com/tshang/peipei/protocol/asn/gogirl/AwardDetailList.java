...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/AwardDetailList.java
//
//   Java class for ASN.1 definition AwardDetailList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>AwardDetailList</tt>.
...
public class AwardDetailList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public AwardDetailList() {}

  /** copy constructor */
  public AwardDetailList (AwardDetailList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((AwardDetail)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((AwardDetail)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      AwardDetail tmp = new AwardDetail();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((AwardDetail)(e.nextElement())).print(os, indent+2);
