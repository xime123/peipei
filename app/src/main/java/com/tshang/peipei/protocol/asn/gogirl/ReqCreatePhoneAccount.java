...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqCreatePhoneAccount.java
//
//   Java class for ASN.1 definition ReqCreatePhoneAccount as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqCreatePhoneAccount</tt>.
...
public class ReqCreatePhoneAccount implements ASN1Type {
  ...
  /** default constructor */
  public ReqCreatePhoneAccount() {}

  /** copy constructor */
  public ReqCreatePhoneAccount (ReqCreatePhoneAccount arg) {
    uid = arg.uid;
