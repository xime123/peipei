...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspDelTipoff.java
//
//   Java class for ASN.1 definition RspDelTipoff as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspDelTipoff</tt>.
...
public class RspDelTipoff implements ASN1Type {
  ...
  /** copy constructor */
  public RspDelTipoff (RspDelTipoff arg) {
    retcode = arg.retcode;
