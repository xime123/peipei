...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspDelSkill.java
//
//   Java class for ASN.1 definition RspDelSkill as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspDelSkill</tt>.
...
public class RspDelSkill implements ASN1Type {
  ...
  /** copy constructor */
  public RspDelSkill (RspDelSkill arg) {
    retcode = arg.retcode;
