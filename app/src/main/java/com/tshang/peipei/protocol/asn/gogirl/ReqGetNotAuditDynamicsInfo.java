...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetNotAuditDynamicsInfo.java
//
//   Java class for ASN.1 definition ReqGetNotAuditDynamicsInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetNotAuditDynamicsInfo</tt>.
...
public class ReqGetNotAuditDynamicsInfo implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetNotAuditDynamicsInfo() {}

  /** copy constructor */
  public ReqGetNotAuditDynamicsInfo (ReqGetNotAuditDynamicsInfo arg) {
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
    num = arg.num;
