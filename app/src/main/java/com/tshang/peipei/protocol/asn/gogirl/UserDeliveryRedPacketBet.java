...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/UserDeliveryRedPacketBet.java
//
//   Java class for ASN.1 definition UserDeliveryRedPacketBet as defined in
//   module GOGIRL.
//   This file was generated by Snacc for Java at Wed Dec 09 19:09:01 2015
//-----------------------------------------------------------------------------
...
/** This class represents the ASN.1 SEQUENCE type <tt>UserDeliveryRedPacketBet</tt>.
  * For each sequence member, sequence classes contain a
  * public member variable of the corresponding Java type.
  * @author Snacc for Java
  * @version Wed Dec 09 19:08:59 2015

  */

public class UserDeliveryRedPacketBet implements ASN1Type {
  ...
  /** member variable representing the sequence member redPacketBetCreateInfoList of type RedPacketBetCreateInfoList */
  public RedPacketBetCreateInfoList redPacketBetCreateInfoList = new RedPacketBetCreateInfoList();
  ...
  /** default constructor */
  public UserDeliveryRedPacketBet() {}

  /** copy constructor */
  public UserDeliveryRedPacketBet (UserDeliveryRedPacketBet arg) {
    curid = arg.curid;
    uid = arg.uid;
    redPacketBetCreateInfoList = new RedPacketBetCreateInfoList(arg.redPacketBetCreateInfoList);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    redPacketBetCreateInfoList.encode(enc);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    redPacketBetCreateInfoList.decode(dec);
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("redPacketBetCreateInfoList = ");
    redPacketBetCreateInfoList.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
