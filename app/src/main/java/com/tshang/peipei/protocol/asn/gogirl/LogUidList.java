...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/LogUidList.java
//
//   Java class for ASN.1 definition LogUidList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>LogUidList</tt>.
...
public class LogUidList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public LogUidList() {}

  /** copy constructor */
  public LogUidList (LogUidList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((LogUidInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((LogUidInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((LogUidInfo)(e.nextElement())).print(os, indent+2);
