...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/UserFollowList.java
//
//   Java class for ASN.1 definition UserFollowList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>UserFollowList</tt>.
...
public class UserFollowList implements ASN1Type {
  ...
  /** member variable representing the sequence member followlist of type FollowInfoList */
  public FollowInfoList followlist = new FollowInfoList();
  ...
  /** copy constructor */
  public UserFollowList (UserFollowList arg) {
    curid = arg.curid;
    uid = arg.uid;
    followlist = new FollowInfoList(arg.followlist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
