...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/AwardTextInfo.java
//
//   Java class for ASN.1 definition AwardTextInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>AwardTextInfo</tt>.
...
public class AwardTextInfo implements ASN1Type {
  ...
  /** default constructor */
  public AwardTextInfo() {}

  /** copy constructor */
  public AwardTextInfo (AwardTextInfo arg) {
    id = arg.id;
