...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GiftFeedInfo.java
//
//   Java class for ASN.1 definition GiftFeedInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GiftFeedInfo</tt>.
...
public class GiftFeedInfo implements ASN1Type {

  /** member variable representing the sequence member latesttime of type java.math.BigInteger */
  public java.math.BigInteger latesttime;
  ...
  /** copy constructor */
  public GiftFeedInfo (GiftFeedInfo arg) {
    latesttime = arg.latesttime;
    total = arg.total;
