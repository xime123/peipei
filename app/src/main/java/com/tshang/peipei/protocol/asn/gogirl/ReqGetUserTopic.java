...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetUserTopic.java
//
//   Java class for ASN.1 definition ReqGetUserTopic as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetUserTopic</tt>.
...
public class ReqGetUserTopic implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetUserTopic() {}

  /** copy constructor */
  public ReqGetUserTopic (ReqGetUserTopic arg) {
    selfuid = arg.selfuid;
