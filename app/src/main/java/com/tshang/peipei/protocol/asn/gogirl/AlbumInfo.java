...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/AlbumInfo.java
//
//   Java class for ASN.1 definition AlbumInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>AlbumInfo</tt>.
...
public class AlbumInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member albumdesc of type byte[] */
  ...
  /** member variable representing the sequence member lastupdatetime of type java.math.BigInteger */
  public java.math.BigInteger lastupdatetime;
  /** member variable representing the sequence member coverpic of type byte[] */
  public byte[] coverpic;
  /** member variable representing the sequence member coverpicid of type java.math.BigInteger */
  public java.math.BigInteger coverpicid;
  /** member variable representing the sequence member coverpickey of type byte[] */
  public byte[] coverpickey;
  /** member variable representing the sequence member accessloyalty of type java.math.BigInteger */
  public java.math.BigInteger accessloyalty;
  /** member variable representing the sequence member photototal of type java.math.BigInteger */
  ...
  /** copy constructor */
  public AlbumInfo (AlbumInfo arg) {
    id = arg.id;
    albumname = new byte[arg.albumname.length];
    System.arraycopy(arg.albumname,0,albumname,0,arg.albumname.length);
    albumdesc = new byte[arg.albumdesc.length];
    System.arraycopy(arg.albumdesc,0,albumdesc,0,arg.albumdesc.length);
    createtime = arg.createtime;
    lastupdatetime = arg.lastupdatetime;
    coverpic = new byte[arg.coverpic.length];
    System.arraycopy(arg.coverpic,0,coverpic,0,arg.coverpic.length);
    coverpicid = arg.coverpicid;
    coverpickey = new byte[arg.coverpickey.length];
    System.arraycopy(arg.coverpickey,0,coverpickey,0,arg.coverpickey.length);
    accessloyalty = arg.accessloyalty;
    photototal = arg.photototal;
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeOctetString(albumdesc);
    enc.encodeInteger(createtime);
    enc.encodeInteger(lastupdatetime);
    enc.encodeOctetString(coverpic);
    enc.encodeInteger(coverpicid);
    enc.encodeOctetString(coverpickey);
    enc.encodeInteger(accessloyalty);
    enc.encodeInteger(photototal);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    albumdesc = dec.decodeOctetString();
    createtime = dec.decodeInteger();
    lastupdatetime = dec.decodeInteger();
    coverpic = dec.decodeOctetString();
    coverpicid = dec.decodeInteger();
    coverpickey = dec.decodeOctetString();
    accessloyalty = dec.decodeInteger();
    photototal = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("albumdesc = ");
    os.print(Hex.toString(albumdesc));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("createtime = ");
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("lastupdatetime = ");
    os.print(lastupdatetime.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("coverpic = ");
    os.print(Hex.toString(coverpic));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("coverpicid = ");
    os.print(coverpicid.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("coverpickey = ");
    os.print(Hex.toString(coverpickey));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("accessloyalty = ");
    os.print(accessloyalty.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("photototal = ");
    os.print(photototal.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
