...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqDeliverDetainGift.java
//
//   Java class for ASN.1 definition ReqDeliverDetainGift as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqDeliverDetainGift</tt>.
...
public class ReqDeliverDetainGift implements ASN1Type {
  ...
  /** default constructor */
  public ReqDeliverDetainGift() {}

  /** copy constructor */
  public ReqDeliverDetainGift (ReqDeliverDetainGift arg) {
    fromuid = arg.fromuid;
    touid = arg.touid;
    giftid = arg.giftid;
    giftnum = arg.giftnum;
