...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetRelevantPeopleList.java
//
//   Java class for ASN.1 definition ReqGetRelevantPeopleList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetRelevantPeopleList</tt>.
...
public class ReqGetRelevantPeopleList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetRelevantPeopleList() {}

  /** copy constructor */
  public ReqGetRelevantPeopleList (ReqGetRelevantPeopleList arg) {
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
    num = arg.num;
