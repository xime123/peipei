...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GroupInfoListV2.java
//
//   Java class for ASN.1 definition GroupInfoListV2 as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>GroupInfoListV2</tt>.
...
public class GroupInfoListV2 extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public GroupInfoListV2() {}

  /** copy constructor */
  public GroupInfoListV2 (GroupInfoListV2 arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((GroupInfoV2)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((GroupInfoV2)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      GroupInfoV2 tmp = new GroupInfoV2();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((GroupInfoV2)(e.nextElement())).print(os, indent+2);
