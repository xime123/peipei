...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetDaybookList.java
//
//   Java class for ASN.1 definition ReqGetDaybookList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetDaybookList</tt>.
...
public class ReqGetDaybookList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetDaybookList() {}

  /** copy constructor */
  public ReqGetDaybookList (ReqGetDaybookList arg) {
    selfuid = arg.selfuid;
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
