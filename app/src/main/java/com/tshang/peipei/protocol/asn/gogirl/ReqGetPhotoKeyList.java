...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetPhotoKeyList.java
//
//   Java class for ASN.1 definition ReqGetPhotoKeyList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetPhotoKeyList</tt>.
...
public class ReqGetPhotoKeyList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetPhotoKeyList() {}

  /** copy constructor */
  public ReqGetPhotoKeyList (ReqGetPhotoKeyList arg) {
    selfuid = arg.selfuid;
    uid = arg.uid;
    albumid = arg.albumid;
    start = arg.start;
