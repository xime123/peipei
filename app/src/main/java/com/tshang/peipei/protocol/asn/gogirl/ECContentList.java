...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ECContentList.java
//
//   Java class for ASN.1 definition ECContentList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>ECContentList</tt>.
...
public class ECContentList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public ECContentList() {}

  /** copy constructor */
  public ECContentList (ECContentList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((ECContent)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((ECContent)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((ECContent)(e.nextElement())).print(os, indent+2);
