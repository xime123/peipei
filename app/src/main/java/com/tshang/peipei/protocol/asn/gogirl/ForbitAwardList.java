...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ForbitAwardList.java
//
//   Java class for ASN.1 definition ForbitAwardList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>ForbitAwardList</tt>.
...
public class ForbitAwardList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public ForbitAwardList() {}

  /** copy constructor */
  public ForbitAwardList (ForbitAwardList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((ForbitAward)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((ForbitAward)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      ForbitAward tmp = new ForbitAward();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((ForbitAward)(e.nextElement())).print(os, indent+2);
