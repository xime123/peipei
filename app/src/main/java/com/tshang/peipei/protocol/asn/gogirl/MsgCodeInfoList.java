...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/MsgCodeInfoList.java
//
//   Java class for ASN.1 definition MsgCodeInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>MsgCodeInfoList</tt>.
...
public class MsgCodeInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public MsgCodeInfoList() {}

  /** copy constructor */
  public MsgCodeInfoList (MsgCodeInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((MsgCodeInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((MsgCodeInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      MsgCodeInfo tmp = new MsgCodeInfo();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((MsgCodeInfo)(e.nextElement())).print(os, indent+2);
