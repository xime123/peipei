...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspGetOnlineWithLoacleUserListV2.java
//
//   Java class for ASN.1 definition RspGetOnlineWithLoacleUserListV2 as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetOnlineWithLoacleUserListV2</tt>.
...
public class RspGetOnlineWithLoacleUserListV2 implements ASN1Type {
  ...
  /** member variable representing the sequence member userInfoAndSkillInfoList of type UserInfoAndSkillInfoList */
  public UserInfoAndSkillInfoList userInfoAndSkillInfoList = new UserInfoAndSkillInfoList();
  /** member variable representing the sequence member isend of type java.math.BigInteger */
  public java.math.BigInteger isend;

  /** default constructor */
  public RspGetOnlineWithLoacleUserListV2() {}

  /** copy constructor */
  public RspGetOnlineWithLoacleUserListV2 (RspGetOnlineWithLoacleUserListV2 arg) {
    retcode = arg.retcode;
    ...
    total = arg.total;
    userInfoAndSkillInfoList = new UserInfoAndSkillInfoList(arg.userInfoAndSkillInfoList);
    isend = arg.isend;
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    userInfoAndSkillInfoList.encode(enc);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    userInfoAndSkillInfoList.decode(dec);
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("userInfoAndSkillInfoList = ");
    userInfoAndSkillInfoList.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("isend = ");
