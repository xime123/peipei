...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RetFollowInfo.java
//
//   Java class for ASN.1 definition RetFollowInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RetFollowInfo</tt>.
...
public class RetFollowInfo implements ASN1Type {

  /** member variable representing the sequence member followinfo of type FollowInfo */
  public FollowInfo followinfo = new FollowInfo();
  /** member variable representing the sequence member followuserinfo of type GoGirlUserInfo */
  public GoGirlUserInfo followuserinfo = new GoGirlUserInfo();
  ...
  /** default constructor */
  public RetFollowInfo() {}

  /** copy constructor */
  public RetFollowInfo (RetFollowInfo arg) {
    followinfo = new FollowInfo(arg.followinfo);
    followuserinfo = new GoGirlUserInfo(arg.followuserinfo);
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    followinfo.encode(enc);
    followuserinfo.encode(enc);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    followinfo.decode(dec);
    followuserinfo.decode(dec);
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.print("followinfo = ");
    followinfo.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("followuserinfo = ");
    followuserinfo.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("charmnum = ");
