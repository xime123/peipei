...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqDelFans.java
//
//   Java class for ASN.1 definition ReqDelFans as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqDelFans</tt>.
...
public class ReqDelFans implements ASN1Type {
  ...
  /** copy constructor */
  public ReqDelFans (ReqDelFans arg) {
    selfuid = arg.selfuid;
    peeruid = arg.peeruid;
  }
