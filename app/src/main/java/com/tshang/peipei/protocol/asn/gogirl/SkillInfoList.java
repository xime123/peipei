...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/SkillInfoList.java
//
//   Java class for ASN.1 definition SkillInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>SkillInfoList</tt>.
...
public class SkillInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public SkillInfoList() {}

  /** copy constructor */
  public SkillInfoList (SkillInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((SkillInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((SkillInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((SkillInfo)(e.nextElement())).print(os, indent+2);
