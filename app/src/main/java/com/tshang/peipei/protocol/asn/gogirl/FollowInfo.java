...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/FollowInfo.java
//
//   Java class for ASN.1 definition FollowInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>FollowInfo</tt>.
...
public class FollowInfo implements ASN1Type {

  /** member variable representing the sequence member id of type java.math.BigInteger */
  public java.math.BigInteger id;
  /** member variable representing the sequence member followtime of type java.math.BigInteger */
  public java.math.BigInteger followtime;
  /** member variable representing the sequence member followuid of type java.math.BigInteger */
  public java.math.BigInteger followuid;
  ...
  /** member variable representing the sequence member alias of type byte[] */
  public byte[] alias;
  ...
  /** copy constructor */
  public FollowInfo (FollowInfo arg) {
    id = arg.id;
    followtime = arg.followtime;
    followuid = arg.followuid;
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
    revint4 = arg.revint4;
    alias = new byte[arg.alias.length];
    System.arraycopy(arg.alias,0,alias,0,arg.alias.length);
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(followtime);
    enc.encodeInteger(followuid);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    followtime = dec.decodeInteger();
    followuid = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("followtime = ");
    os.print(followtime.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("followuid = ");
    os.print(followuid.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
