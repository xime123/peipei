...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/PeriodNumIncInfo.java
//
//   Java class for ASN.1 definition PeriodNumIncInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>PeriodNumIncInfo</tt>.
...
public class PeriodNumIncInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member numchangeloglist of type NumChangeLogInfoList */
  public NumChangeLogInfoList numchangeloglist = new NumChangeLogInfoList();
  ...
  /** copy constructor */
  public PeriodNumIncInfo (PeriodNumIncInfo arg) {
    span = arg.span;
    type = arg.type;
    createtime = arg.createtime;
    numchangeloglist = new NumChangeLogInfoList(arg.numchangeloglist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("numchangeloglist = ");
    numchangeloglist.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
