...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetDistance.java
//
//   Java class for ASN.1 definition ReqGetDistance as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetDistance</tt>.
...
public class ReqGetDistance implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetDistance() {}

  /** copy constructor */
  public ReqGetDistance (ReqGetDistance arg) {
    selfuid = arg.selfuid;
    peeruid = arg.peeruid;
  }
