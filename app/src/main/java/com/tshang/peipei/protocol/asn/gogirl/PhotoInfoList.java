...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/PhotoInfoList.java
//
//   Java class for ASN.1 definition PhotoInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>PhotoInfoList</tt>.
...
public class PhotoInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public PhotoInfoList() {}

  /** copy constructor */
  public PhotoInfoList (PhotoInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((PhotoInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((PhotoInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((PhotoInfo)(e.nextElement())).print(os, indent+2);
