...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspGetUserTopic.java
//
//   Java class for ASN.1 definition RspGetUserTopic as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetUserTopic</tt>.
...
public class RspGetUserTopic implements ASN1Type {
  ...
  /** member variable representing the sequence member topic of type TopicInfo */
  public TopicInfo topic = new TopicInfo();

  /** default constructor */
  public RspGetUserTopic() {}

  /** copy constructor */
  public RspGetUserTopic (RspGetUserTopic arg) {
    retcode = arg.retcode;
    retmsg = new byte[arg.retmsg.length];
    System.arraycopy(arg.retmsg,0,retmsg,0,arg.retmsg.length);
    total = arg.total;
    topic = new TopicInfo(arg.topic);
  }
