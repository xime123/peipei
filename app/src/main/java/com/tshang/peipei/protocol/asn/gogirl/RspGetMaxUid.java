...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspGetMaxUid.java
//
//   Java class for ASN.1 definition RspGetMaxUid as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetMaxUid</tt>.
...
public class RspGetMaxUid implements ASN1Type {
  ...
  public byte[] retmsg;
  /** member variable representing the sequence member maxuid of type java.math.BigInteger */
  public java.math.BigInteger maxuid;

  /** default constructor */
  public RspGetMaxUid() {}

  /** copy constructor */
  public RspGetMaxUid (RspGetMaxUid arg) {
    retcode = arg.retcode;
