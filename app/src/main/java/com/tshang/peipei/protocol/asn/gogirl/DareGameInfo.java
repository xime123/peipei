...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/DareGameInfo.java
//
//   Java class for ASN.1 definition DareGameInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>DareGameInfo</tt>.
...
public class DareGameInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member playtime of type java.math.BigInteger */
  public java.math.BigInteger playtime;
  ...
  public byte[] auth;
  /** member variable representing the sequence member flowers of type java.math.BigInteger */
  public java.math.BigInteger flowers;
  /** member variable representing the sequence member eggs of type java.math.BigInteger */
  public java.math.BigInteger eggs;
  /** member variable representing the sequence member bricks of type java.math.BigInteger */
  public java.math.BigInteger bricks;
  ...
  /** copy constructor */
  public DareGameInfo (DareGameInfo arg) {
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(playtime);
    enc.encodeOctetString(nick);
    enc.encodeOctetString(auth);
    enc.encodeInteger(flowers);
    enc.encodeInteger(eggs);
    enc.encodeInteger(bricks);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    playtime = dec.decodeInteger();
    nick = dec.decodeOctetString();
    auth = dec.decodeOctetString();
    flowers = dec.decodeInteger();
    eggs = dec.decodeInteger();
    bricks = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("flowers = ");
    os.print(flowers.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("eggs = ");
    os.print(eggs.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("bricks = ");
    os.print(bricks.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint1 = ");
