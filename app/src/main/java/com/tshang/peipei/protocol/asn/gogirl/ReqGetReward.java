...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetReward.java
//
//   Java class for ASN.1 definition ReqGetReward as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetReward</tt>.
...
public class ReqGetReward implements ASN1Type {
  ...
  /** copy constructor */
  public ReqGetReward (ReqGetReward arg) {
    uid = arg.uid;
    type = arg.type;
  }
