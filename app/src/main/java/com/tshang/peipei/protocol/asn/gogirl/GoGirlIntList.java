...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GoGirlIntList.java
//
//   Java class for ASN.1 definition GoGirlIntList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>GoGirlIntList</tt>.
...
public class GoGirlIntList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public GoGirlIntList() {}

  /** copy constructor */
  public GoGirlIntList (GoGirlIntList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((java.math.BigInteger)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      enc.encodeInteger(((java.math.BigInteger)(e.nextElement())));
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      os.print(((java.math.BigInteger)(e.nextElement())).toString());
