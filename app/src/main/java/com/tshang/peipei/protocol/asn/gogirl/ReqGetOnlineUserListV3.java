...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetOnlineUserListV3.java
//
//   Java class for ASN.1 definition ReqGetOnlineUserListV3 as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetOnlineUserListV3</tt>.
...
public class ReqGetOnlineUserListV3 implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetOnlineUserListV3() {}

  /** copy constructor */
  public ReqGetOnlineUserListV3 (ReqGetOnlineUserListV3 arg) {
    uid = arg.uid;
    sex = arg.sex;
    start = arg.start;
    num = arg.num;
