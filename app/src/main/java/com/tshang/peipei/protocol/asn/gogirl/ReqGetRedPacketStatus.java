...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetRedPacketStatus.java
//
//   Java class for ASN.1 definition ReqGetRedPacketStatus as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetRedPacketStatus</tt>.
...
public class ReqGetRedPacketStatus implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetRedPacketStatus() {}

  /** copy constructor */
  public ReqGetRedPacketStatus (ReqGetRedPacketStatus arg) {
    type = arg.type;
    uid = arg.uid;
