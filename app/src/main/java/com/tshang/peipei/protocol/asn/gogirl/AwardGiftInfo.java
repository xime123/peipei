...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/AwardGiftInfo.java
//
//   Java class for ASN.1 definition AwardGiftInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>AwardGiftInfo</tt>.
...
public class AwardGiftInfo implements ASN1Type {
  ...
  public byte[] name;
  /** member variable representing the sequence member pricesilver of type java.math.BigInteger */
  public java.math.BigInteger pricesilver;
  /** member variable representing the sequence member pricegold of type java.math.BigInteger */
  public java.math.BigInteger pricegold;
  /** member variable representing the sequence member loyaltyeffect of type java.math.BigInteger */
  public java.math.BigInteger loyaltyeffect;
  /** member variable representing the sequence member scoreeffect of type java.math.BigInteger */
  public java.math.BigInteger scoreeffect;
  /** member variable representing the sequence member charmeffect of type java.math.BigInteger */
  public java.math.BigInteger charmeffect;
  ...
  /** copy constructor */
  public AwardGiftInfo (AwardGiftInfo arg) {
    id = arg.id;
    name = new byte[arg.name.length];
    System.arraycopy(arg.name,0,name,0,arg.name.length);
    pricesilver = arg.pricesilver;
    pricegold = arg.pricegold;
    loyaltyeffect = arg.loyaltyeffect;
    scoreeffect = arg.scoreeffect;
    charmeffect = arg.charmeffect;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(pricesilver);
    enc.encodeInteger(pricegold);
    enc.encodeInteger(loyaltyeffect);
    enc.encodeInteger(scoreeffect);
    enc.encodeInteger(charmeffect);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    pricesilver = dec.decodeInteger();
    pricegold = dec.decodeInteger();
    loyaltyeffect = dec.decodeInteger();
    scoreeffect = dec.decodeInteger();
    charmeffect = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("pricesilver = ");
    os.print(pricesilver.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("pricegold = ");
    os.print(pricegold.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("loyaltyeffect = ");
    os.print(loyaltyeffect.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("scoreeffect = ");
    os.print(scoreeffect.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("charmeffect = ");
    os.print(charmeffect.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("pickey = ");
