...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetShareData.java
//
//   Java class for ASN.1 definition ReqGetShareData as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetShareData</tt>.
...
public class ReqGetShareData implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetShareData() {}

  /** copy constructor */
  public ReqGetShareData (ReqGetShareData arg) {
    selfuid = arg.selfuid;
    uid = arg.uid;
  }
