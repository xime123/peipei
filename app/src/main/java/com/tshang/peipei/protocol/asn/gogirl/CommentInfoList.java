...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/CommentInfoList.java
//
//   Java class for ASN.1 definition CommentInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>CommentInfoList</tt>.
...
public class CommentInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public CommentInfoList() {}

  /** copy constructor */
  public CommentInfoList (CommentInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((CommentInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((CommentInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((CommentInfo)(e.nextElement())).print(os, indent+2);
