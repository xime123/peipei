...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ECContent.java
//
//   Java class for ASN.1 definition ECContent as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ECContent</tt>.
...
public class ECContent implements ASN1Type {
  ...
  /** member variable representing the sequence member contlist of type GoGirlDataInfoList */
  public GoGirlDataInfoList contlist = new GoGirlDataInfoList();
  ...
  /** copy constructor */
  public ECContent (ECContent arg) {
    uid = arg.uid;
    ...
    contlist = new GoGirlDataInfoList(arg.contlist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
