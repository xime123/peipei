...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetUserTopicList.java
//
//   Java class for ASN.1 definition ReqGetUserTopicList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetUserTopicList</tt>.
...
public class ReqGetUserTopicList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetUserTopicList() {}

  /** copy constructor */
  public ReqGetUserTopicList (ReqGetUserTopicList arg) {
    selfuid = arg.selfuid;
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
