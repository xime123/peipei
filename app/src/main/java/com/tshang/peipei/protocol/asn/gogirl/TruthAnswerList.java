...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/TruthAnswerList.java
//
//   Java class for ASN.1 definition TruthAnswerList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>TruthAnswerList</tt>.
...
public class TruthAnswerList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public TruthAnswerList() {}

  /** copy constructor */
  public TruthAnswerList (TruthAnswerList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((TruthAnswer)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((TruthAnswer)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      TruthAnswer tmp = new TruthAnswer();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((TruthAnswer)(e.nextElement())).print(os, indent+2);
