...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ShowRoomInfoList.java
//
//   Java class for ASN.1 definition ShowRoomInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>ShowRoomInfoList</tt>.
...
public class ShowRoomInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public ShowRoomInfoList() {}

  /** copy constructor */
  public ShowRoomInfoList (ShowRoomInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((ShowRoomInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((ShowRoomInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      ShowRoomInfo tmp = new ShowRoomInfo();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((ShowRoomInfo)(e.nextElement())).print(os, indent+2);
