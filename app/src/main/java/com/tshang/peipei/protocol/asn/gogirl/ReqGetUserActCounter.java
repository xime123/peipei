...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetUserActCounter.java
//
//   Java class for ASN.1 definition ReqGetUserActCounter as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetUserActCounter</tt>.
...
public class ReqGetUserActCounter implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetUserActCounter() {}

  /** copy constructor */
  public ReqGetUserActCounter (ReqGetUserActCounter arg) {
    selfuid = arg.selfuid;
    uid = arg.uid;
    taskid = arg.taskid;
  }
