...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/UserRewardInfo.java
//
//   Java class for ASN.1 definition UserRewardInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>UserRewardInfo</tt>.
...
public class UserRewardInfo implements ASN1Type {

  /** member variable representing the sequence member act of type java.math.BigInteger */
  public java.math.BigInteger act;
  /** member variable representing the sequence member acttime of type java.math.BigInteger */
  public java.math.BigInteger acttime;
  ...
  /** copy constructor */
  public UserRewardInfo (UserRewardInfo arg) {
    act = arg.act;
    acttime = arg.acttime;
