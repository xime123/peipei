...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/SkillInfo.java
//
//   Java class for ASN.1 definition SkillInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>SkillInfo</tt>.
...
public class SkillInfo implements ASN1Type {

  /** member variable representing the sequence member type of type java.math.BigInteger */
  public java.math.BigInteger type;
  /** member variable representing the sequence member skillkind of type java.math.BigInteger */
  public java.math.BigInteger skillkind;
  ...
  /** copy constructor */
  public SkillInfo (SkillInfo arg) {
    type = arg.type;
    skillkind = arg.skillkind;
    skillid = arg.skillid;
