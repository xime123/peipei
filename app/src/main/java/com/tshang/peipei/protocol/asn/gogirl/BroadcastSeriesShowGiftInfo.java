...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/BroadcastSeriesShowGiftInfo.java
//
//   Java class for ASN.1 definition BroadcastSeriesShowGiftInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>BroadcastSeriesShowGiftInfo</tt>.
...
public class BroadcastSeriesShowGiftInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member giftpickey of type byte[] */
  public byte[] giftpickey;
  /** member variable representing the sequence member giftname of type byte[] */
  ...
  /** default constructor */
  public BroadcastSeriesShowGiftInfo() {}

  /** copy constructor */
  public BroadcastSeriesShowGiftInfo (BroadcastSeriesShowGiftInfo arg) {
    ...
    series = arg.series;
    giftid = arg.giftid;
    giftpickey = new byte[arg.giftpickey.length];
    System.arraycopy(arg.giftpickey,0,giftpickey,0,arg.giftpickey.length);
    giftname = new byte[arg.giftname.length];
    System.arraycopy(arg.giftname,0,giftname,0,arg.giftname.length);
    giftnum = arg.giftnum;
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeOctetString(giftpickey);
    enc.encodeOctetString(giftname);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    giftpickey = dec.decodeOctetString();
    giftname = dec.decodeOctetString();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("giftpickey = ");
    os.print(Hex.toString(giftpickey));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("giftname = ");
    os.print(Hex.toString(giftname));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("giftnum = ");
