...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetAwardDetail.java
//
//   Java class for ASN.1 definition ReqGetAwardDetail as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetAwardDetail</tt>.
...
public class ReqGetAwardDetail implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetAwardDetail() {}

  /** copy constructor */
  public ReqGetAwardDetail (ReqGetAwardDetail arg) {
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
    num = arg.num;
