...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetAboutMeReplyInfo.java
//
//   Java class for ASN.1 definition ReqGetAboutMeReplyInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetAboutMeReplyInfo</tt>.
...
public class ReqGetAboutMeReplyInfo implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetAboutMeReplyInfo() {}

  /** copy constructor */
  public ReqGetAboutMeReplyInfo (ReqGetAboutMeReplyInfo arg) {
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
    num = arg.num;
