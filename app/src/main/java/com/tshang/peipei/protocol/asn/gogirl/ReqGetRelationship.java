...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetRelationship.java
//
//   Java class for ASN.1 definition ReqGetRelationship as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetRelationship</tt>.
...
public class ReqGetRelationship implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetRelationship() {}

  /** copy constructor */
  public ReqGetRelationship (ReqGetRelationship arg) {
    selfuid = arg.selfuid;
