...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetInviteUserList.java
//
//   Java class for ASN.1 definition ReqGetInviteUserList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetInviteUserList</tt>.
...
public class ReqGetInviteUserList implements ASN1Type {

  /** member variable representing the sequence member selfuid of type java.math.BigInteger */
  public java.math.BigInteger selfuid;
  /** member variable representing the sequence member hostuid of type java.math.BigInteger */
  public java.math.BigInteger hostuid;
  ...
  /** default constructor */
  public ReqGetInviteUserList() {}

  /** copy constructor */
  public ReqGetInviteUserList (ReqGetInviteUserList arg) {
    selfuid = arg.selfuid;
    hostuid = arg.hostuid;
    start = arg.start;
    num = arg.num;
