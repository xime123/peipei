...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetRankSkillList.java
//
//   Java class for ASN.1 definition ReqGetRankSkillList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetRankSkillList</tt>.
...
public class ReqGetRankSkillList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetRankSkillList() {}

  /** copy constructor */
  public ReqGetRankSkillList (ReqGetRankSkillList arg) {
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
  }
