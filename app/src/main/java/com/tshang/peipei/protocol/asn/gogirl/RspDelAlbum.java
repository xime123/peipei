...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspDelAlbum.java
//
//   Java class for ASN.1 definition RspDelAlbum as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspDelAlbum</tt>.
...
public class RspDelAlbum implements ASN1Type {
  ...
  /** copy constructor */
  public RspDelAlbum (RspDelAlbum arg) {
    retcode = arg.retcode;
