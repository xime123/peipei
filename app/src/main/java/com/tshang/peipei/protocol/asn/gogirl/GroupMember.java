...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GroupMember.java
//
//   Java class for ASN.1 definition GroupMember as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GroupMember</tt>.
...
public class GroupMember implements ASN1Type {
  ...
  /** copy constructor */
  public GroupMember (GroupMember arg) {
    groupid = arg.groupid;
    curid = arg.curid;
