...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetGroupInfo.java
//
//   Java class for ASN.1 definition ReqGetGroupInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetGroupInfo</tt>.
...
public class ReqGetGroupInfo implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetGroupInfo() {}

  /** copy constructor */
  public ReqGetGroupInfo (ReqGetGroupInfo arg) {
    uid = arg.uid;
    groupid = arg.groupid;
  }
