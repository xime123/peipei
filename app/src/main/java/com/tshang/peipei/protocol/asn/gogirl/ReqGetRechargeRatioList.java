...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetRechargeRatioList.java
//
//   Java class for ASN.1 definition ReqGetRechargeRatioList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetRechargeRatioList</tt>.
...
public class ReqGetRechargeRatioList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetRechargeRatioList() {}

  /** copy constructor */
  public ReqGetRechargeRatioList (ReqGetRechargeRatioList arg) {
    uid = arg.uid;
    fromos = arg.fromos;
  }
