...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GiftInfoList.java
//
//   Java class for ASN.1 definition GiftInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>GiftInfoList</tt>.
...
public class GiftInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public GiftInfoList() {}

  /** copy constructor */
  public GiftInfoList (GiftInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((GiftInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((GiftInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((GiftInfo)(e.nextElement())).print(os, indent+2);
