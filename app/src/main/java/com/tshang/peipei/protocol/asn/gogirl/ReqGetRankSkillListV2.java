...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetRankSkillListV2.java
//
//   Java class for ASN.1 definition ReqGetRankSkillListV2 as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetRankSkillListV2</tt>.
...
public class ReqGetRankSkillListV2 implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetRankSkillListV2() {}

  /** copy constructor */
  public ReqGetRankSkillListV2 (ReqGetRankSkillListV2 arg) {
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
    num = arg.num;
