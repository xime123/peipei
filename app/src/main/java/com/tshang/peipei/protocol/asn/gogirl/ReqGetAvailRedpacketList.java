...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetAvailRedpacketList.java
//
//   Java class for ASN.1 definition ReqGetAvailRedpacketList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetAvailRedpacketList</tt>.
...
public class ReqGetAvailRedpacketList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetAvailRedpacketList() {}

  /** copy constructor */
  public ReqGetAvailRedpacketList (ReqGetAvailRedpacketList arg) {
    type = arg.type;
    uid = arg.uid;
  }
