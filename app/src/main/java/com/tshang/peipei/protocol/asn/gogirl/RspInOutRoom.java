...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspInOutRoom.java
//
//   Java class for ASN.1 definition RspInOutRoom as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspInOutRoom</tt>.
...
public class RspInOutRoom implements ASN1Type {
  ...
  /** copy constructor */
  public RspInOutRoom (RspInOutRoom arg) {
    retcode = arg.retcode;
