...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGSkillInfoList.java
//
//   Java class for ASN.1 definition GGSkillInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>GGSkillInfoList</tt>.
...
public class GGSkillInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public GGSkillInfoList() {}

  /** copy constructor */
  public GGSkillInfoList (GGSkillInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((GGSkillInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((GGSkillInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      GGSkillInfo tmp = new GGSkillInfo();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((GGSkillInfo)(e.nextElement())).print(os, indent+2);
