...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetFollowList.java
//
//   Java class for ASN.1 definition ReqGetFollowList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetFollowList</tt>.
...
public class ReqGetFollowList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetFollowList() {}

  /** copy constructor */
  public ReqGetFollowList (ReqGetFollowList arg) {
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
  }
