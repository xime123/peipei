...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/DareUserInfoList.java
//
//   Java class for ASN.1 definition DareUserInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>DareUserInfoList</tt>.
...
public class DareUserInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public DareUserInfoList() {}

  /** copy constructor */
  public DareUserInfoList (DareUserInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((DareUserInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((DareUserInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      DareUserInfo tmp = new DareUserInfo();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((DareUserInfo)(e.nextElement())).print(os, indent+2);
