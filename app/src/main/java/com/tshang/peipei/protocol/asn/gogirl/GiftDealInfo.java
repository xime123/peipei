...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GiftDealInfo.java
//
//   Java class for ASN.1 definition GiftDealInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GiftDealInfo</tt>.
...
public class GiftDealInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member gift of type GiftInfo */
  ...
  /** member variable representing the sequence member giftdealstatus of type java.math.BigInteger */
  public java.math.BigInteger giftdealstatus;
  ...
  /** copy constructor */
  public GiftDealInfo (GiftDealInfo arg) {
    id = arg.id;
    ...
    tosex = arg.tosex;
    gift = new GiftInfo(arg.gift);
    giftnum = arg.giftnum;
    giftdealstatus = arg.giftdealstatus;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
    revint4 = arg.revint4;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(giftdealstatus);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    giftdealstatus = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("giftdealstatus = ");
    os.print(giftdealstatus.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint1 = ");
