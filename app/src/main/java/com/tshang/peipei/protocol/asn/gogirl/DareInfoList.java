...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/DareInfoList.java
//
//   Java class for ASN.1 definition DareInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>DareInfoList</tt>.
...
public class DareInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public DareInfoList() {}

  /** copy constructor */
  public DareInfoList (DareInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((DareInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((DareInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((DareInfo)(e.nextElement())).print(os, indent+2);
