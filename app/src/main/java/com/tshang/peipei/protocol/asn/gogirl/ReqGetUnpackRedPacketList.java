...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetUnpackRedPacketList.java
//
//   Java class for ASN.1 definition ReqGetUnpackRedPacketList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetUnpackRedPacketList</tt>.
...
public class ReqGetUnpackRedPacketList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetUnpackRedPacketList() {}

  /** copy constructor */
  public ReqGetUnpackRedPacketList (ReqGetUnpackRedPacketList arg) {
    selfuid = arg.selfuid;
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
