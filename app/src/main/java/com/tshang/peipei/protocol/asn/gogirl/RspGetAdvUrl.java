...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspGetAdvUrl.java
//
//   Java class for ASN.1 definition RspGetAdvUrl as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetAdvUrl</tt>.
...
public class RspGetAdvUrl implements ASN1Type {
  ...
  /** copy constructor */
  public RspGetAdvUrl (RspGetAdvUrl arg) {
    retcode = arg.retcode;
