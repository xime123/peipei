...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspGetRelationship.java
//
//   Java class for ASN.1 definition RspGetRelationship as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetRelationship</tt>.
...
public class RspGetRelationship implements ASN1Type {
  ...
  public byte[] retmsg;
  /** member variable representing the sequence member relationship of type RelationshipInfo */
  public RelationshipInfo relationship = new RelationshipInfo();

  /** default constructor */
  public RspGetRelationship() {}

  /** copy constructor */
  public RspGetRelationship (RspGetRelationship arg) {
    retcode = arg.retcode;
    retmsg = new byte[arg.retmsg.length];
    System.arraycopy(arg.retmsg,0,retmsg,0,arg.retmsg.length);
    relationship = new RelationshipInfo(arg.relationship);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("relationship = ");
    relationship.print(os, indent+2);
    os.println();
