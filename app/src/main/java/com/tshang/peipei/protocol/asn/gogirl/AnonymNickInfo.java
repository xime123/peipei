...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/AnonymNickInfo.java
//
//   Java class for ASN.1 definition AnonymNickInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>AnonymNickInfo</tt>.
...
public class AnonymNickInfo implements ASN1Type {
  ...
  /** default constructor */
  public AnonymNickInfo() {}

  /** copy constructor */
  public AnonymNickInfo (AnonymNickInfo arg) {
    uid = arg.uid;
    id = arg.id;
