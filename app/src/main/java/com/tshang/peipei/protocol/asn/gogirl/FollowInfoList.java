...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/FollowInfoList.java
//
//   Java class for ASN.1 definition FollowInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>FollowInfoList</tt>.
...
public class FollowInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public FollowInfoList() {}

  /** copy constructor */
  public FollowInfoList (FollowInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((FollowInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((FollowInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((FollowInfo)(e.nextElement())).print(os, indent+2);
