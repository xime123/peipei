...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/SkillInteractiveInfo.java
//
//   Java class for ASN.1 definition SkillInteractiveInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>SkillInteractiveInfo</tt>.
...
public class SkillInteractiveInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member additionalword of type byte[] */
  public byte[] additionalword;
  ...
  /** default constructor */
  public SkillInteractiveInfo() {}

  /** copy constructor */
  public SkillInteractiveInfo (SkillInteractiveInfo arg) {
    ...
    additionalword = new byte[arg.additionalword.length];
    System.arraycopy(arg.additionalword,0,additionalword,0,arg.additionalword.length);
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeOctetString(additionalword);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    additionalword = dec.decodeOctetString();
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("additionalword = ");
    os.print(Hex.toString(additionalword));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("createtime = ");
