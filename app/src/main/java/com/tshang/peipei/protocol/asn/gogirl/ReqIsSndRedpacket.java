...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqIsSndRedpacket.java
//
//   Java class for ASN.1 definition ReqIsSndRedpacket as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqIsSndRedpacket</tt>.
...
public class ReqIsSndRedpacket implements ASN1Type {
  ...
  /** default constructor */
  public ReqIsSndRedpacket() {}

  /** copy constructor */
  public ReqIsSndRedpacket (ReqIsSndRedpacket arg) {
    type = arg.type;
    uid = arg.uid;
  }
