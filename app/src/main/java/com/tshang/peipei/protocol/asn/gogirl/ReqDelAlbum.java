...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqDelAlbum.java
//
//   Java class for ASN.1 definition ReqDelAlbum as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqDelAlbum</tt>.
...
public class ReqDelAlbum implements ASN1Type {
  ...
  /** copy constructor */
  public ReqDelAlbum (ReqDelAlbum arg) {
    uid = arg.uid;
    albumid = arg.albumid;
  }
