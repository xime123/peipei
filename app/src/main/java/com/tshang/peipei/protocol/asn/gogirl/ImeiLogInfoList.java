...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ImeiLogInfoList.java
//
//   Java class for ASN.1 definition ImeiLogInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>ImeiLogInfoList</tt>.
...
public class ImeiLogInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public ImeiLogInfoList() {}

  /** copy constructor */
  public ImeiLogInfoList (ImeiLogInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((ImeiLogInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((ImeiLogInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      ImeiLogInfo tmp = new ImeiLogInfo();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((ImeiLogInfo)(e.nextElement())).print(os, indent+2);
