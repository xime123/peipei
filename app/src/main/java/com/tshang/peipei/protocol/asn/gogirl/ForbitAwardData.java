...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ForbitAwardData.java
//
//   Java class for ASN.1 definition ForbitAwardData as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ForbitAwardData</tt>.
...
public class ForbitAwardData implements ASN1Type {
  ...
  /** member variable representing the sequence member forbitAwardList of type ForbitAwardList */
  public ForbitAwardList forbitAwardList = new ForbitAwardList();
  ...
  /** default constructor */
  public ForbitAwardData() {}

  /** copy constructor */
  public ForbitAwardData (ForbitAwardData arg) {
    group = arg.group;
    curid = arg.curid;
    forbitAwardList = new ForbitAwardList(arg.forbitAwardList);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("forbitAwardList = ");
    forbitAwardList.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
