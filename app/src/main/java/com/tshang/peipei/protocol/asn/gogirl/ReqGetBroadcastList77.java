...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetBroadcastList77.java
//
//   Java class for ASN.1 definition ReqGetBroadcastList77 as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetBroadcastList77</tt>.
...
public class ReqGetBroadcastList77 implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetBroadcastList77() {}

  /** copy constructor */
  public ReqGetBroadcastList77 (ReqGetBroadcastList77 arg) {
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
    num = arg.num;
