...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetAwardDetailV3.java
//
//   Java class for ASN.1 definition ReqGetAwardDetailV3 as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetAwardDetailV3</tt>.
...
public class ReqGetAwardDetailV3 implements ASN1Type {

  /** member variable representing the sequence member uid of type java.math.BigInteger */
  public java.math.BigInteger uid;
  /** member variable representing the sequence member nickid of type java.math.BigInteger */
  public java.math.BigInteger nickid;
  ...
  /** default constructor */
  public ReqGetAwardDetailV3() {}

  /** copy constructor */
  public ReqGetAwardDetailV3 (ReqGetAwardDetailV3 arg) {
    uid = arg.uid;
    nickid = arg.nickid;
    type = arg.type;
    start = arg.start;
