...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/LogUidInfo.java
//
//   Java class for ASN.1 definition LogUidInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>LogUidInfo</tt>.
...
public class LogUidInfo implements ASN1Type {
  ...
  /** copy constructor */
  public LogUidInfo (LogUidInfo arg) {
    uid = arg.uid;
