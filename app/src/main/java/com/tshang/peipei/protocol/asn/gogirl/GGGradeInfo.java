...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGGradeInfo.java
//
//   Java class for ASN.1 definition GGGradeInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GGGradeInfo</tt>.
...
public class GGGradeInfo implements ASN1Type {

  /** member variable representing the sequence member id of type java.math.BigInteger */
  public java.math.BigInteger id;
  /** member variable representing the sequence member minconsumesilvercoin of type java.math.BigInteger */
  public java.math.BigInteger minconsumesilvercoin;
  /** member variable representing the sequence member maxconusmesilvercoin of type java.math.BigInteger */
  public java.math.BigInteger maxconusmesilvercoin;
  /** member variable representing the sequence member minconsumegoldcoin of type java.math.BigInteger */
  public java.math.BigInteger minconsumegoldcoin;
  /** member variable representing the sequence member maxconsumegoldcoin of type java.math.BigInteger */
  public java.math.BigInteger maxconsumegoldcoin;
  /** member variable representing the sequence member mincharm of type java.math.BigInteger */
  public java.math.BigInteger mincharm;
  /** member variable representing the sequence member maxcharm of type java.math.BigInteger */
  public java.math.BigInteger maxcharm;
  ...
  public byte[] pickey;
  /** member variable representing the sequence member groupmembernum of type java.math.BigInteger */
  public java.math.BigInteger groupmembernum;
  /** member variable representing the sequence member colorfulbroadcastnum of type java.math.BigInteger */
  public java.math.BigInteger colorfulbroadcastnum;
  ...
  /** copy constructor */
  public GGGradeInfo (GGGradeInfo arg) {
    id = arg.id;
    minconsumesilvercoin = arg.minconsumesilvercoin;
    maxconusmesilvercoin = arg.maxconusmesilvercoin;
    minconsumegoldcoin = arg.minconsumegoldcoin;
    maxconsumegoldcoin = arg.maxconsumegoldcoin;
    mincharm = arg.mincharm;
    maxcharm = arg.maxcharm;
    ...
    groupmembernum = arg.groupmembernum;
    colorfulbroadcastnum = arg.colorfulbroadcastnum;
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(minconsumesilvercoin);
    enc.encodeInteger(maxconusmesilvercoin);
    enc.encodeInteger(minconsumegoldcoin);
    enc.encodeInteger(maxconsumegoldcoin);
    enc.encodeInteger(mincharm);
    enc.encodeInteger(maxcharm);
    enc.encodeOctetString(title);
    enc.encodeOctetString(pickey);
    enc.encodeInteger(groupmembernum);
    enc.encodeInteger(colorfulbroadcastnum);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    minconsumesilvercoin = dec.decodeInteger();
    maxconusmesilvercoin = dec.decodeInteger();
    minconsumegoldcoin = dec.decodeInteger();
    maxconsumegoldcoin = dec.decodeInteger();
    mincharm = dec.decodeInteger();
    maxcharm = dec.decodeInteger();
    title = dec.decodeOctetString();
    pickey = dec.decodeOctetString();
    groupmembernum = dec.decodeInteger();
    colorfulbroadcastnum = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("minconsumesilvercoin = ");
    os.print(minconsumesilvercoin.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("maxconusmesilvercoin = ");
    os.print(maxconusmesilvercoin.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("minconsumegoldcoin = ");
    os.print(minconsumegoldcoin.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("maxconsumegoldcoin = ");
    os.print(maxconsumegoldcoin.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("mincharm = ");
    os.print(mincharm.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("maxcharm = ");
    os.print(maxcharm.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("title = ");
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("groupmembernum = ");
    os.print(groupmembernum.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("colorfulbroadcastnum = ");
    os.print(colorfulbroadcastnum.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
