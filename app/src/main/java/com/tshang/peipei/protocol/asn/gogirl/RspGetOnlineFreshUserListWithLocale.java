...
//
//   File: ./src/com/tshang/peipei/asn/gogirl/RspGetOnlineFreshUserListWithLocale.java
//
//   Java class for ASN.1 definition RspGetOnlineFreshUserListWithLocale as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetOnlineFreshUserListWithLocale</tt>.
...
public class RspGetOnlineFreshUserListWithLocale implements ASN1Type {
  ...
  /** member variable representing the sequence member userlist of type GoGirlUserInfoList */
  public GoGirlUserInfoList userlist = new GoGirlUserInfoList();
  /** member variable representing the sequence member isend of type java.math.BigInteger */
  public java.math.BigInteger isend;

  /** default constructor */
  public RspGetOnlineFreshUserListWithLocale() {}

  /** copy constructor */
  public RspGetOnlineFreshUserListWithLocale (RspGetOnlineFreshUserListWithLocale arg) {
    retcode = arg.retcode;
    ...
    total = arg.total;
    userlist = new GoGirlUserInfoList(arg.userlist);
    isend = arg.isend;
  }
