...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetOnlineUserList.java
//
//   Java class for ASN.1 definition ReqGetOnlineUserList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetOnlineUserList</tt>.
...
public class ReqGetOnlineUserList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetOnlineUserList() {}

  /** copy constructor */
  public ReqGetOnlineUserList (ReqGetOnlineUserList arg) {
    uid = arg.uid;
    sex = arg.sex;
    start = arg.start;
    num = arg.num;
