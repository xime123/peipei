...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspObtainInviteScore.java
//
//   Java class for ASN.1 definition RspObtainInviteScore as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspObtainInviteScore</tt>.
...
public class RspObtainInviteScore implements ASN1Type {
  ...
  /** member variable representing the sequence member userproperty of type UserPropertyInfo */
  public UserPropertyInfo userproperty = new UserPropertyInfo();

  /** default constructor */
  public RspObtainInviteScore() {}

  /** copy constructor */
  public RspObtainInviteScore (RspObtainInviteScore arg) {
    retcode = arg.retcode;
    retmsg = new byte[arg.retmsg.length];
    System.arraycopy(arg.retmsg,0,retmsg,0,arg.retmsg.length);
    uid = arg.uid;
    userproperty = new UserPropertyInfo(arg.userproperty);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("userproperty = ");
    userproperty.print(os, indent+2);
    os.println();
