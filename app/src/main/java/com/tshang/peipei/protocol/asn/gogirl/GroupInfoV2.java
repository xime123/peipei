...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GroupInfoV2.java
//
//   Java class for ASN.1 definition GroupInfoV2 as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GroupInfoV2</tt>.
...
public class GroupInfoV2 implements ASN1Type {
  ...
  /** member variable representing the sequence member owner of type java.math.BigInteger */
  public java.math.BigInteger owner;
  /** member variable representing the sequence member groupname of type byte[] */
  public byte[] groupname;
  /** member variable representing the sequence member groupbadgekey of type byte[] */
  public byte[] groupbadgekey;
  /** member variable representing the sequence member groupnotice of type byte[] */
  public byte[] groupnotice;
  /** member variable representing the sequence member groupdesc of type byte[] */
  public byte[] groupdesc;
  ...
  /** member variable representing the sequence member level of type java.math.BigInteger */
  public java.math.BigInteger level;
  ...
  public byte[] secret;
  /** member variable representing the sequence member membernum of type java.math.BigInteger */
  public java.math.BigInteger membernum;
  /** member variable representing the sequence member tojoinuids of type UserSimpleInfoList */
  public UserSimpleInfoList tojoinuids = new UserSimpleInfoList();
  /** member variable representing the sequence member ranknum of type java.math.BigInteger */
  public java.math.BigInteger ranknum;
  /** member variable representing the sequence member mennum of type java.math.BigInteger */
  public java.math.BigInteger mennum;
  /** member variable representing the sequence member womennum of type java.math.BigInteger */
  public java.math.BigInteger womennum;
  ...
  /** copy constructor */
  public GroupInfoV2 (GroupInfoV2 arg) {
    groupid = arg.groupid;
    createtime = arg.createtime;
    owner = arg.owner;
    groupname = new byte[arg.groupname.length];
    System.arraycopy(arg.groupname,0,groupname,0,arg.groupname.length);
    groupbadgekey = new byte[arg.groupbadgekey.length];
    System.arraycopy(arg.groupbadgekey,0,groupbadgekey,0,arg.groupbadgekey.length);
    groupnotice = new byte[arg.groupnotice.length];
    System.arraycopy(arg.groupnotice,0,groupnotice,0,arg.groupnotice.length);
    groupdesc = new byte[arg.groupdesc.length];
    System.arraycopy(arg.groupdesc,0,groupdesc,0,arg.groupdesc.length);
    ...
    membernum = arg.membernum;
    tojoinuids = new UserSimpleInfoList(arg.tojoinuids);
    ranknum = arg.ranknum;
    mennum = arg.mennum;
    womennum = arg.womennum;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
    revint4 = arg.revint4;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(owner);
    enc.encodeOctetString(groupname);
    enc.encodeOctetString(groupbadgekey);
    enc.encodeOctetString(groupnotice);
    enc.encodeOctetString(groupdesc);
    enc.encodeOctetString(memo);
    enc.encodeInteger(maxmembernum);
    enc.encodeInteger(level);
    enc.encodeInteger(endtime);
    enc.encodeOctetString(secret);
    enc.encodeInteger(membernum);
    tojoinuids.encode(enc);
    enc.encodeInteger(ranknum);
    enc.encodeInteger(mennum);
    enc.encodeInteger(womennum);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    owner = dec.decodeInteger();
    groupname = dec.decodeOctetString();
    groupbadgekey = dec.decodeOctetString();
    groupnotice = dec.decodeOctetString();
    groupdesc = dec.decodeOctetString();
    memo = dec.decodeOctetString();
    maxmembernum = dec.decodeInteger();
    level = dec.decodeInteger();
    endtime = dec.decodeInteger();
    secret = dec.decodeOctetString();
    membernum = dec.decodeInteger();
    tojoinuids.decode(dec);
    ranknum = dec.decodeInteger();
    mennum = dec.decodeInteger();
    womennum = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("owner = ");
    os.print(owner.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("groupname = ");
    os.print(Hex.toString(groupname));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("groupbadgekey = ");
    os.print(Hex.toString(groupbadgekey));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("groupnotice = ");
    os.print(Hex.toString(groupnotice));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("groupdesc = ");
    os.print(Hex.toString(groupdesc));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("memo = ");
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("membernum = ");
    os.print(membernum.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("tojoinuids = ");
    tojoinuids.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("ranknum = ");
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("mennum = ");
    os.print(mennum.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("womennum = ");
    os.print(womennum.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint1 = ");
