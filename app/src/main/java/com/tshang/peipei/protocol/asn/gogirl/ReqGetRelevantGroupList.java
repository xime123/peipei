...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetRelevantGroupList.java
//
//   Java class for ASN.1 definition ReqGetRelevantGroupList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetRelevantGroupList</tt>.
...
public class ReqGetRelevantGroupList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetRelevantGroupList() {}

  /** copy constructor */
  public ReqGetRelevantGroupList (ReqGetRelevantGroupList arg) {
    selfuid = arg.selfuid;
    uid = arg.uid;
  }
