...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspSetDareInfo.java
//
//   Java class for ASN.1 definition RspSetDareInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspSetDareInfo</tt>.
...
public class RspSetDareInfo implements ASN1Type {
  ...
  public byte[] retmsg;
  /** member variable representing the sequence member dareinfo of type DareInfo */
  public DareInfo dareinfo = new DareInfo();

  /** default constructor */
  public RspSetDareInfo() {}

  /** copy constructor */
  public RspSetDareInfo (RspSetDareInfo arg) {
    retcode = arg.retcode;
    retmsg = new byte[arg.retmsg.length];
    System.arraycopy(arg.retmsg,0,retmsg,0,arg.retmsg.length);
    dareinfo = new DareInfo(arg.dareinfo);
  }
