...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetGiftList.java
//
//   Java class for ASN.1 definition ReqGetGiftList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetGiftList</tt>.
...
public class ReqGetGiftList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetGiftList() {}

  /** copy constructor */
  public ReqGetGiftList (ReqGetGiftList arg) {
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
  }
