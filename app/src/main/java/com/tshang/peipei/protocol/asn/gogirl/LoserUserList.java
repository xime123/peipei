...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/LoserUserList.java
//
//   Java class for ASN.1 definition LoserUserList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>LoserUserList</tt>.
...
public class LoserUserList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public LoserUserList() {}

  /** copy constructor */
  public LoserUserList (LoserUserList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((DareGameInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((DareGameInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      DareGameInfo tmp = new DareGameInfo();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((DareGameInfo)(e.nextElement())).print(os, indent+2);
