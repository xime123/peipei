...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetVisitorList.java
//
//   Java class for ASN.1 definition ReqGetVisitorList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetVisitorList</tt>.
...
public class ReqGetVisitorList implements ASN1Type {
  ...
  /** copy constructor */
  public ReqGetVisitorList (ReqGetVisitorList arg) {
    selfuid = arg.selfuid;
    hostuid = arg.hostuid;
    start = arg.start;
    num = arg.num;
