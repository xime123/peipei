...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGTaskInfoList.java
//
//   Java class for ASN.1 definition GGTaskInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>GGTaskInfoList</tt>.
...
public class GGTaskInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public GGTaskInfoList() {}

  /** copy constructor */
  public GGTaskInfoList (GGTaskInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((GGTaskInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((GGTaskInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((GGTaskInfo)(e.nextElement())).print(os, indent+2);
