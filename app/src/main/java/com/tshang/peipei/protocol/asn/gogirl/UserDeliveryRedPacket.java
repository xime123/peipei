...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/UserDeliveryRedPacket.java
//
//   Java class for ASN.1 definition UserDeliveryRedPacket as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>UserDeliveryRedPacket</tt>.
...
public class UserDeliveryRedPacket implements ASN1Type {
  ...
  /** default constructor */
  public UserDeliveryRedPacket() {}

  /** copy constructor */
  public UserDeliveryRedPacket (UserDeliveryRedPacket arg) {
    curid = arg.curid;
    uid = arg.uid;
