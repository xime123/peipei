...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetDeliverRedPacketList.java
//
//   Java class for ASN.1 definition ReqGetDeliverRedPacketList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetDeliverRedPacketList</tt>.
...
public class ReqGetDeliverRedPacketList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetDeliverRedPacketList() {}

  /** copy constructor */
  public ReqGetDeliverRedPacketList (ReqGetDeliverRedPacketList arg) {
    selfuid = arg.selfuid;
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
