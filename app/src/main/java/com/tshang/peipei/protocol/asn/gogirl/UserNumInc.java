...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/UserNumInc.java
//
//   Java class for ASN.1 definition UserNumInc as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>UserNumInc</tt>.
...
public class UserNumInc implements ASN1Type {

  /** member variable representing the sequence member uid of type java.math.BigInteger */
  public java.math.BigInteger uid;
  /** member variable representing the sequence member periodnuminclist of type PeriodNumIncInfoList */
  public PeriodNumIncInfoList periodnuminclist = new PeriodNumIncInfoList();
  ...
  /** copy constructor */
  public UserNumInc (UserNumInc arg) {
    uid = arg.uid;
    periodnuminclist = new PeriodNumIncInfoList(arg.periodnuminclist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("periodnuminclist = ");
    periodnuminclist.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
