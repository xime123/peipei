...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ParticipantInfoList.java
//
//   Java class for ASN.1 definition ParticipantInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>ParticipantInfoList</tt>.
...
public class ParticipantInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public ParticipantInfoList() {}

  /** copy constructor */
  public ParticipantInfoList (ParticipantInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((ParticipantInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((ParticipantInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      ParticipantInfo tmp = new ParticipantInfo();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((ParticipantInfo)(e.nextElement())).print(os, indent+2);
