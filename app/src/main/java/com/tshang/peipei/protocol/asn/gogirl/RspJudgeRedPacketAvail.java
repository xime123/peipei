...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspJudgeRedPacketAvail.java
//
//   Java class for ASN.1 definition RspJudgeRedPacketAvail as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspJudgeRedPacketAvail</tt>.
...
public class RspJudgeRedPacketAvail implements ASN1Type {
  ...
  public byte[] retmsg;
  /** member variable representing the sequence member result of type java.math.BigInteger */
  public java.math.BigInteger result;

  /** default constructor */
  public RspJudgeRedPacketAvail() {}

  /** copy constructor */
  public RspJudgeRedPacketAvail (RspJudgeRedPacketAvail arg) {
    retcode = arg.retcode;
