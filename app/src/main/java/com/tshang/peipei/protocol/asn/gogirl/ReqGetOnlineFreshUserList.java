...
//
//   File: ./src/com/tshang/peipei/asn/gogirl/ReqGetOnlineFreshUserList.java
//
//   Java class for ASN.1 definition ReqGetOnlineFreshUserList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetOnlineFreshUserList</tt>.
...
public class ReqGetOnlineFreshUserList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetOnlineFreshUserList() {}

  /** copy constructor */
  public ReqGetOnlineFreshUserList (ReqGetOnlineFreshUserList arg) {
    uid = arg.uid;
    sex = arg.sex;
    start = arg.start;
    num = arg.num;
