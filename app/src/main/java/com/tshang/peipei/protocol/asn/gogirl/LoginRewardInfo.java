...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/LoginRewardInfo.java
//
//   Java class for ASN.1 definition LoginRewardInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>LoginRewardInfo</tt>.
...
public class LoginRewardInfo implements ASN1Type {

  /** member variable representing the sequence member days of type java.math.BigInteger */
  public java.math.BigInteger days;
  ...
  /** copy constructor */
  public LoginRewardInfo (LoginRewardInfo arg) {
    days = arg.days;
