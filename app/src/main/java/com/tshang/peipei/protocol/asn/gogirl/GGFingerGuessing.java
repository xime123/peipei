...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGFingerGuessing.java
//
//   Java class for ASN.1 definition GGFingerGuessing as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GGFingerGuessing</tt>.
...
public class GGFingerGuessing implements ASN1Type {

  /** member variable representing the sequence member group of type java.math.BigInteger */
  public java.math.BigInteger group;
  /** member variable representing the sequence member curid of type java.math.BigInteger */
  public java.math.BigInteger curid;
  /** member variable representing the sequence member fingerguessinglist of type FingerGuessingInfoList */
  public FingerGuessingInfoList fingerguessinglist = new FingerGuessingInfoList();
  ...
  /** default constructor */
  public GGFingerGuessing() {}

  /** copy constructor */
  public GGFingerGuessing (GGFingerGuessing arg) {
    group = arg.group;
    curid = arg.curid;
    fingerguessinglist = new FingerGuessingInfoList(arg.fingerguessinglist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(group);
    enc.encodeInteger(curid);
    fingerguessinglist.encode(enc);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    group = dec.decodeInteger();
    curid = dec.decodeInteger();
    fingerguessinglist.decode(dec);
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("fingerguessinglist = ");
    fingerguessinglist.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
