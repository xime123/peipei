...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RetFollowShowInfo.java
//
//   Java class for ASN.1 definition RetFollowShowInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RetFollowShowInfo</tt>.
...
public class RetFollowShowInfo implements ASN1Type {

  /** member variable representing the sequence member followshowinfo of type FollowShowInfo */
  public FollowShowInfo followshowinfo = new FollowShowInfo();
  ...
  /** default constructor */
  public RetFollowShowInfo() {}

  /** copy constructor */
  public RetFollowShowInfo (RetFollowShowInfo arg) {
    followshowinfo = new FollowShowInfo(arg.followshowinfo);
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.print("followshowinfo = ");
    followshowinfo.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("topicinfo = ");
