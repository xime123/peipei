...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetBroadcastListById.java
//
//   Java class for ASN.1 definition ReqGetBroadcastListById as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetBroadcastListById</tt>.
...
public class ReqGetBroadcastListById implements ASN1Type {
  ...
  /** member variable representing the sequence member startid of type java.math.BigInteger */
  public java.math.BigInteger startid;
  ...
  /** default constructor */
  public ReqGetBroadcastListById() {}

  /** copy constructor */
  public ReqGetBroadcastListById (ReqGetBroadcastListById arg) {
    selfuid = arg.selfuid;
    type = arg.type;
    startid = arg.startid;
    step = arg.step;
