...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetAppConf.java
//
//   Java class for ASN.1 definition ReqGetAppConf as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetAppConf</tt>.
...
public class ReqGetAppConf implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetAppConf() {}

  /** copy constructor */
  public ReqGetAppConf (ReqGetAppConf arg) {
    uid = arg.uid;
    appver = arg.appver;
    fromos = arg.fromos;
  }
