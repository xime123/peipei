...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetSkillList.java
//
//   Java class for ASN.1 definition ReqGetSkillList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetSkillList</tt>.
...
public class ReqGetSkillList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetSkillList() {}

  /** copy constructor */
  public ReqGetSkillList (ReqGetSkillList arg) {
    selfuid = arg.selfuid;
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
