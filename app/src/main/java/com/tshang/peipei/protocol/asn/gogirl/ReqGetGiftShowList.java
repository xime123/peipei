...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetGiftShowList.java
//
//   Java class for ASN.1 definition ReqGetGiftShowList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetGiftShowList</tt>.
...
public class ReqGetGiftShowList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetGiftShowList() {}

  /** copy constructor */
  public ReqGetGiftShowList (ReqGetGiftShowList arg) {
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
  }
