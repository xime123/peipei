...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspDecUserProperty.java
//
//   Java class for ASN.1 definition RspDecUserProperty as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspDecUserProperty</tt>.
...
public class RspDecUserProperty implements ASN1Type {
  ...
  /** default constructor */
  public RspDecUserProperty() {}

  /** copy constructor */
  public RspDecUserProperty (RspDecUserProperty arg) {
    retcode = arg.retcode;
