...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/TruthInfoList.java
//
//   Java class for ASN.1 definition TruthInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>TruthInfoList</tt>.
...
public class TruthInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public TruthInfoList() {}

  /** copy constructor */
  public TruthInfoList (TruthInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((TruthInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((TruthInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((TruthInfo)(e.nextElement())).print(os, indent+2);
