...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/FollowShowInfo.java
//
//   Java class for ASN.1 definition FollowShowInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>FollowShowInfo</tt>.
...
public class FollowShowInfo implements ASN1Type {
  ...
  /** default constructor */
  public FollowShowInfo() {}

  /** copy constructor */
  public FollowShowInfo (FollowShowInfo arg) {
    id = arg.id;
