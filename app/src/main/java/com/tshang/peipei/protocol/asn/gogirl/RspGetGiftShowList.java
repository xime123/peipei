...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspGetGiftShowList.java
//
//   Java class for ASN.1 definition RspGetGiftShowList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetGiftShowList</tt>.
...
public class RspGetGiftShowList implements ASN1Type {
  ...
  /** member variable representing the sequence member giftlist of type GiftInfoList */
  public GiftInfoList giftlist = new GiftInfoList();

  /** default constructor */
  public RspGetGiftShowList() {}

  /** copy constructor */
  public RspGetGiftShowList (RspGetGiftShowList arg) {
    retcode = arg.retcode;
    retmsg = new byte[arg.retmsg.length];
    System.arraycopy(arg.retmsg,0,retmsg,0,arg.retmsg.length);
    total = arg.total;
    giftlist = new GiftInfoList(arg.giftlist);
  }
