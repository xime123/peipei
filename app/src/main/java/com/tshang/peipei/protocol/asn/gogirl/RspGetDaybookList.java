...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspGetDaybookList.java
//
//   Java class for ASN.1 definition RspGetDaybookList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetDaybookList</tt>.
...
public class RspGetDaybookList implements ASN1Type {
  ...
  /** member variable representing the sequence member daybooklist of type GoGirlDaybookInfoList */
  public GoGirlDaybookInfoList daybooklist = new GoGirlDaybookInfoList();

  /** default constructor */
  public RspGetDaybookList() {}

  /** copy constructor */
  public RspGetDaybookList (RspGetDaybookList arg) {
    retcode = arg.retcode;
    retmsg = new byte[arg.retmsg.length];
    System.arraycopy(arg.retmsg,0,retmsg,0,arg.retmsg.length);
    total = arg.total;
    daybooklist = new GoGirlDaybookInfoList(arg.daybooklist);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("daybooklist = ");
    daybooklist.print(os, indent+2);
    os.println();
