...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqExchangeGoodsV2.java
//
//   Java class for ASN.1 definition ReqExchangeGoodsV2 as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqExchangeGoodsV2</tt>.
...
public class ReqExchangeGoodsV2 implements ASN1Type {

  /** member variable representing the sequence member uid of type java.math.BigInteger */
  public java.math.BigInteger uid;
  /** member variable representing the sequence member goodsname of type byte[] */
  public byte[] goodsname;
  ...
  /** default constructor */
  public ReqExchangeGoodsV2() {}

  /** copy constructor */
  public ReqExchangeGoodsV2 (ReqExchangeGoodsV2 arg) {
    uid = arg.uid;
    goodsname = new byte[arg.goodsname.length];
    System.arraycopy(arg.goodsname,0,goodsname,0,arg.goodsname.length);
    score = arg.score;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeOctetString(goodsname);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    goodsname = dec.decodeOctetString();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("goodsname = ");
    os.print(Hex.toString(goodsname));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("score = ");
