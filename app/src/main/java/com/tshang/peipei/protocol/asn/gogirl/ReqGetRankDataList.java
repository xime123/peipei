...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetRankDataList.java
//
//   Java class for ASN.1 definition ReqGetRankDataList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetRankDataList</tt>.
...
public class ReqGetRankDataList implements ASN1Type {

  /** member variable representing the sequence member uid of type java.math.BigInteger */
  public java.math.BigInteger uid;
  /** member variable representing the sequence member rankid of type java.math.BigInteger */
  public java.math.BigInteger rankid;
  ...
  /** default constructor */
  public ReqGetRankDataList() {}

  /** copy constructor */
  public ReqGetRankDataList (ReqGetRankDataList arg) {
    uid = arg.uid;
    rankid = arg.rankid;
    start = arg.start;
    num = arg.num;
