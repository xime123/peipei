...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetUserDynamicsInfo.java
//
//   Java class for ASN.1 definition ReqGetUserDynamicsInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetUserDynamicsInfo</tt>.
...
public class ReqGetUserDynamicsInfo implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetUserDynamicsInfo() {}

  /** copy constructor */
  public ReqGetUserDynamicsInfo (ReqGetUserDynamicsInfo arg) {
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
    num = arg.num;
