...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspGetTipoffTopicList.java
//
//   Java class for ASN.1 definition RspGetTipoffTopicList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetTipoffTopicList</tt>.
...
public class RspGetTipoffTopicList implements ASN1Type {
  ...
  /** member variable representing the sequence member tipofftopiclist of type TipoffInfoList */
  public TipoffInfoList tipofftopiclist = new TipoffInfoList();

  /** default constructor */
  public RspGetTipoffTopicList() {}

  /** copy constructor */
  public RspGetTipoffTopicList (RspGetTipoffTopicList arg) {
    retcode = arg.retcode;
    retmsg = new byte[arg.retmsg.length];
    System.arraycopy(arg.retmsg,0,retmsg,0,arg.retmsg.length);
    total = arg.total;
    tipofftopiclist = new TipoffInfoList(arg.tipofftopiclist);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("tipofftopiclist = ");
    tipofftopiclist.print(os, indent+2);
    os.println();
