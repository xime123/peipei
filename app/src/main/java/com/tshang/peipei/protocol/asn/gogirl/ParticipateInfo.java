...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ParticipateInfo.java
//
//   Java class for ASN.1 definition ParticipateInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ParticipateInfo</tt>.
...
public class ParticipateInfo implements ASN1Type {

  /** member variable representing the sequence member id of type java.math.BigInteger */
  public java.math.BigInteger id;
  /** member variable representing the sequence member issndawardmsg of type java.math.BigInteger */
  public java.math.BigInteger issndawardmsg;
  ...
  /** copy constructor */
  public ParticipateInfo (ParticipateInfo arg) {
    id = arg.id;
    issndawardmsg = arg.issndawardmsg;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(issndawardmsg);
    userinfo.encode(enc);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    issndawardmsg = dec.decodeInteger();
    userinfo.decode(dec);
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("issndawardmsg = ");
    os.print(issndawardmsg.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("userinfo = ");
