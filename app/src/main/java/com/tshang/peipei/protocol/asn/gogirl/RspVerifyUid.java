...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspVerifyUid.java
//
//   Java class for ASN.1 definition RspVerifyUid as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspVerifyUid</tt>.
...
public class RspVerifyUid implements ASN1Type {
  ...
  /** copy constructor */
  public RspVerifyUid (RspVerifyUid arg) {
    retcode = arg.retcode;
