...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/TopicCounterInfo.java
//
//   Java class for ASN.1 definition TopicCounterInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>TopicCounterInfo</tt>.
...
public class TopicCounterInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member catchnum of type java.math.BigInteger */
  public java.math.BigInteger catchnum;
  /** member variable representing the sequence member favnum of type java.math.BigInteger */
  public java.math.BigInteger favnum;
  ...
  /** member variable representing the sequence member topicstatusbit of type java.math.BigInteger */
  public java.math.BigInteger topicstatusbit;
  ...
  /** copy constructor */
  public TopicCounterInfo (TopicCounterInfo arg) {
    topicuid = arg.topicuid;
    topicid = arg.topicid;
    catchnum = arg.catchnum;
    favnum = arg.favnum;
    commentnum = arg.commentnum;
    replynum = arg.replynum;
    appreciatenum = arg.appreciatenum;
    topicstatusbit = arg.topicstatusbit;
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("catchnum = ");
    os.print(catchnum.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("favnum = ");
    os.print(favnum.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("commentnum = ");
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("topicstatusbit = ");
    os.print(topicstatusbit.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
