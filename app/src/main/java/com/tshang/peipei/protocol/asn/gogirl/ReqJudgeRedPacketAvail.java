...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqJudgeRedPacketAvail.java
//
//   Java class for ASN.1 definition ReqJudgeRedPacketAvail as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqJudgeRedPacketAvail</tt>.
...
public class ReqJudgeRedPacketAvail implements ASN1Type {
  ...
  /** default constructor */
  public ReqJudgeRedPacketAvail() {}

  /** copy constructor */
  public ReqJudgeRedPacketAvail (ReqJudgeRedPacketAvail arg) {
    type = arg.type;
    uid = arg.uid;
  }
