...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGUserTask.java
//
//   Java class for ASN.1 definition GGUserTask as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GGUserTask</tt>.
...
public class GGUserTask implements ASN1Type {
  ...
  /** copy constructor */
  public GGUserTask (GGUserTask arg) {
    uid = arg.uid;
