...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGUserActCounter.java
//
//   Java class for ASN.1 definition GGUserActCounter as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GGUserActCounter</tt>.
...
public class GGUserActCounter implements ASN1Type {

  /** member variable representing the sequence member uid of type java.math.BigInteger */
  public java.math.BigInteger uid;
  /** member variable representing the sequence member counterlist of type GGActCounterInfoList */
  public GGActCounterInfoList counterlist = new GGActCounterInfoList();
  ...
  /** default constructor */
  public GGUserActCounter() {}

  /** copy constructor */
  public GGUserActCounter (GGUserActCounter arg) {
    uid = arg.uid;
    counterlist = new GGActCounterInfoList(arg.counterlist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("counterlist = ");
    counterlist.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
