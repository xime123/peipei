...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGActCounterInfo.java
//
//   Java class for ASN.1 definition GGActCounterInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GGActCounterInfo</tt>.
...
public class GGActCounterInfo implements ASN1Type {

  /** member variable representing the sequence member actid of type java.math.BigInteger */
  public java.math.BigInteger actid;
  ...
  /** member variable representing the sequence member actinfo of type byte[] */
  public byte[] actinfo;
  ...
  /** default constructor */
  public GGActCounterInfo() {}

  /** copy constructor */
  public GGActCounterInfo (GGActCounterInfo arg) {
    actid = arg.actid;
    createtime = arg.createtime;
    num = arg.num;
    span = arg.span;
    actinfo = new byte[arg.actinfo.length];
    System.arraycopy(arg.actinfo,0,actinfo,0,arg.actinfo.length);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
