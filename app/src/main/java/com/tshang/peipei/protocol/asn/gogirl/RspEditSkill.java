...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspEditSkill.java
//
//   Java class for ASN.1 definition RspEditSkill as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspEditSkill</tt>.
...
public class RspEditSkill implements ASN1Type {
  ...
  /** copy constructor */
  public RspEditSkill (RspEditSkill arg) {
    retcode = arg.retcode;
