...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RelationshipInfo.java
//
//   Java class for ASN.1 definition RelationshipInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RelationshipInfo</tt>.
...
public class RelationshipInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member isfocus1 of type java.math.BigInteger */
  public java.math.BigInteger isfocus1;
  /** member variable representing the sequence member isfocus2 of type java.math.BigInteger */
  public java.math.BigInteger isfocus2;
  ...
  /** copy constructor */
  public RelationshipInfo (RelationshipInfo arg) {
    uid1 = arg.uid1;
    uid2 = arg.uid2;
    loyalty = arg.loyalty;
    isfocus = arg.isfocus;
    giftdeallist = new GiftDealInfoList(arg.giftdeallist);
    isfocus1 = arg.isfocus1;
    isfocus2 = arg.isfocus2;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
    revint4 = arg.revint4;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(isfocus1);
    enc.encodeInteger(isfocus2);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    isfocus1 = dec.decodeInteger();
    isfocus2 = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("isfocus1 = ");
    os.print(isfocus1.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("isfocus2 = ");
    os.print(isfocus2.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint2 = ");
