...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/SuggestionInfoList.java
//
//   Java class for ASN.1 definition SuggestionInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>SuggestionInfoList</tt>.
...
public class SuggestionInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public SuggestionInfoList() {}

  /** copy constructor */
  public SuggestionInfoList (SuggestionInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((SuggestionInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((SuggestionInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((SuggestionInfo)(e.nextElement())).print(os, indent+2);
