...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GroupMemberInfo.java
//
//   Java class for ASN.1 definition GroupMemberInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GroupMemberInfo</tt>.
...
public class GroupMemberInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member jointime of type java.math.BigInteger */
  public java.math.BigInteger jointime;
  ...
  /** copy constructor */
  public GroupMemberInfo (GroupMemberInfo arg) {
    id = arg.id;
    uid = arg.uid;
    jointime = arg.jointime;
