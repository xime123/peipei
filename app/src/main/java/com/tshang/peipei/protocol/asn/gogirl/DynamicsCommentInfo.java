...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/DynamicsCommentInfo.java
//
//   Java class for ASN.1 definition DynamicsCommentInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>DynamicsCommentInfo</tt>.
...
public class DynamicsCommentInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member replylist of type DynamicsCommentInfoList */
  public DynamicsCommentInfoList replylist = new DynamicsCommentInfoList();
  ...
  /** default constructor */
  public DynamicsCommentInfo() {}

  /** copy constructor */
  public DynamicsCommentInfo (DynamicsCommentInfo arg) {
    id = arg.id;
    uid = arg.uid;
    ...
    replylist = new DynamicsCommentInfoList(arg.replylist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
