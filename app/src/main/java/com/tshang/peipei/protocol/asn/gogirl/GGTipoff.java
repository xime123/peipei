...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGTipoff.java
//
//   Java class for ASN.1 definition GGTipoff as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GGTipoff</tt>.
...
public class GGTipoff implements ASN1Type {

  /** member variable representing the sequence member curid of type java.math.BigInteger */
  public java.math.BigInteger curid;
  /** member variable representing the sequence member tipofflist of type TipoffInfoList */
  public TipoffInfoList tipofflist = new TipoffInfoList();
  ...
  /** copy constructor */
  public GGTipoff (GGTipoff arg) {
    curid = arg.curid;
    tipofflist = new TipoffInfoList(arg.tipofflist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
