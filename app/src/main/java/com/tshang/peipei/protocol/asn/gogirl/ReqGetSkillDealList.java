...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetSkillDealList.java
//
//   Java class for ASN.1 definition ReqGetSkillDealList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetSkillDealList</tt>.
...
public class ReqGetSkillDealList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetSkillDealList() {}

  /** copy constructor */
  public ReqGetSkillDealList (ReqGetSkillDealList arg) {
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
  }
