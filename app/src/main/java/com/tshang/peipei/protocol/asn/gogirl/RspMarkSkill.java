...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspMarkSkill.java
//
//   Java class for ASN.1 definition RspMarkSkill as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspMarkSkill</tt>.
...
public class RspMarkSkill implements ASN1Type {
  ...
  /** copy constructor */
  public RspMarkSkill (RspMarkSkill arg) {
    retcode = arg.retcode;
