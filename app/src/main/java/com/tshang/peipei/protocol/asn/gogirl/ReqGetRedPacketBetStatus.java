...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetRedPacketBetStatus.java
//
//   Java class for ASN.1 definition ReqGetRedPacketBetStatus as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetRedPacketBetStatus</tt>.
...
public class ReqGetRedPacketBetStatus implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetRedPacketBetStatus() {}

  /** copy constructor */
  public ReqGetRedPacketBetStatus (ReqGetRedPacketBetStatus arg) {
    type = arg.type;
    uid = arg.uid;
