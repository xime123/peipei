...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetAwardTipInfo.java
//
//   Java class for ASN.1 definition ReqGetAwardTipInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetAwardTipInfo</tt>.
...
public class ReqGetAwardTipInfo implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetAwardTipInfo() {}

  /** copy constructor */
  public ReqGetAwardTipInfo (ReqGetAwardTipInfo arg) {
    type = arg.type;
    uid = arg.uid;
  }
