...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetOnlineUserListV2.java
//
//   Java class for ASN.1 definition ReqGetOnlineUserListV2 as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetOnlineUserListV2</tt>.
...
public class ReqGetOnlineUserListV2 implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetOnlineUserListV2() {}

  /** copy constructor */
  public ReqGetOnlineUserListV2 (ReqGetOnlineUserListV2 arg) {
    uid = arg.uid;
    sex = arg.sex;
    start = arg.start;
    num = arg.num;
