...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/SkillDetailList.java
//
//   Java class for ASN.1 definition SkillDetailList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>SkillDetailList</tt>.
...
public class SkillDetailList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public SkillDetailList() {}

  /** copy constructor */
  public SkillDetailList (SkillDetailList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((SkillDetail)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((SkillDetail)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      SkillDetail tmp = new SkillDetail();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((SkillDetail)(e.nextElement())).print(os, indent+2);
