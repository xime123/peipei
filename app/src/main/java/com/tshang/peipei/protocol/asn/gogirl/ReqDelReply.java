...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqDelReply.java
//
//   Java class for ASN.1 definition ReqDelReply as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqDelReply</tt>.
...
public class ReqDelReply implements ASN1Type {
  ...
  /** copy constructor */
  public ReqDelReply (ReqDelReply arg) {
    uid = arg.uid;
