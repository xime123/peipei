...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqSystemReward.java
//
//   Java class for ASN.1 definition ReqSystemReward as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqSystemReward</tt>.
...
public class ReqSystemReward implements ASN1Type {
  ...
  /** default constructor */
  public ReqSystemReward() {}

  /** copy constructor */
  public ReqSystemReward (ReqSystemReward arg) {
    uid = arg.uid;
    taskid = arg.taskid;
  }
