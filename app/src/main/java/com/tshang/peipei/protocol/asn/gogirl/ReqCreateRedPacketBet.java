...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqCreateRedPacketBet.java
//
//   Java class for ASN.1 definition ReqCreateRedPacketBet as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqCreateRedPacketBet</tt>.
...
public class ReqCreateRedPacketBet implements ASN1Type {
  ...
  /** default constructor */
  public ReqCreateRedPacketBet() {}

  /** copy constructor */
  public ReqCreateRedPacketBet (ReqCreateRedPacketBet arg) {
    type = arg.type;
    uid = arg.uid;
