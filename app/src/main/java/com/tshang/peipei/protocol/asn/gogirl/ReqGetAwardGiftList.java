...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetAwardGiftList.java
//
//   Java class for ASN.1 definition ReqGetAwardGiftList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetAwardGiftList</tt>.
...
public class ReqGetAwardGiftList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetAwardGiftList() {}

  /** copy constructor */
  public ReqGetAwardGiftList (ReqGetAwardGiftList arg) {
    type = arg.type;
    uid = arg.uid;
  }
