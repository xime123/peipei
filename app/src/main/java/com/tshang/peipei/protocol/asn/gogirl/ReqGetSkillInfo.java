...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetSkillInfo.java
//
//   Java class for ASN.1 definition ReqGetSkillInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetSkillInfo</tt>.
...
public class ReqGetSkillInfo implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetSkillInfo() {}

  /** copy constructor */
  public ReqGetSkillInfo (ReqGetSkillInfo arg) {
    uid = arg.uid;
    type = arg.type;
    start = arg.start;
    num = arg.num;
