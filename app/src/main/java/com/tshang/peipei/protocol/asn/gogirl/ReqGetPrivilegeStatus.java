...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetPrivilegeStatus.java
//
//   Java class for ASN.1 definition ReqGetPrivilegeStatus as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetPrivilegeStatus</tt>.
...
public class ReqGetPrivilegeStatus implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetPrivilegeStatus() {}

  /** copy constructor */
  public ReqGetPrivilegeStatus (ReqGetPrivilegeStatus arg) {
    uid = arg.uid;
    type = arg.type;
  }
