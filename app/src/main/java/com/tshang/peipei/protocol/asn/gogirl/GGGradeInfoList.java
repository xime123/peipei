...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGGradeInfoList.java
//
//   Java class for ASN.1 definition GGGradeInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>GGGradeInfoList</tt>.
...
public class GGGradeInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public GGGradeInfoList() {}

  /** copy constructor */
  public GGGradeInfoList (GGGradeInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((GGGradeInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((GGGradeInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    while (!dec.endOf(seq_of_nr)) {
      GGGradeInfo tmp = new GGGradeInfo();
      tmp.decode(dec);
      addElement(tmp);
    }
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((GGGradeInfo)(e.nextElement())).print(os, indent+2);
