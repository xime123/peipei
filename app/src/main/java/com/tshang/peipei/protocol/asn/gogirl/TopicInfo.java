...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/TopicInfo.java
//
//   Java class for ASN.1 definition TopicInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>TopicInfo</tt>.
...
public class TopicInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member topicstatus of type java.math.BigInteger */
  public java.math.BigInteger topicstatus;
  ...
  /** member variable representing the sequence member picver of type java.math.BigInteger */
  public java.math.BigInteger picver;
  /** member variable representing the sequence member pichw of type byte[] */
  public byte[] pichw;
  /** member variable representing the sequence member blacklist of type byte[] */
  public byte[] blacklist;
  /** member variable representing the sequence member followcont of type byte[] */
  public byte[] followcont;
  ...
  /** copy constructor */
  public TopicInfo (TopicInfo arg) {
    id = arg.id;
    topicid = arg.topicid;
    ...
    picver = arg.picver;
    pichw = new byte[arg.pichw.length];
    System.arraycopy(arg.pichw,0,pichw,0,arg.pichw.length);
    blacklist = new byte[arg.blacklist.length];
    System.arraycopy(arg.blacklist,0,blacklist,0,arg.blacklist.length);
    followcont = new byte[arg.followcont.length];
    System.arraycopy(arg.followcont,0,followcont,0,arg.followcont.length);
    lo = arg.lo;
    la = arg.la;
    revint0 = arg.revint0;
    revint1 = arg.revint1;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(picver);
    enc.encodeOctetString(pichw);
    enc.encodeOctetString(blacklist);
    enc.encodeOctetString(followcont);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    picver = dec.decodeInteger();
    pichw = dec.decodeOctetString();
    blacklist = dec.decodeOctetString();
    followcont = dec.decodeOctetString();
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("topicstatus = ");
    os.print(topicstatus.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("picver = ");
    os.print(picver.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("pichw = ");
    os.print(Hex.toString(pichw));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("blacklist = ");
    os.print(Hex.toString(blacklist));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("followcont = ");
    os.print(Hex.toString(followcont));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("lo = ");
