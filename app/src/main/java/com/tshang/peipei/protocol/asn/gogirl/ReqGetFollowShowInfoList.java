...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetFollowShowInfoList.java
//
//   Java class for ASN.1 definition ReqGetFollowShowInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetFollowShowInfoList</tt>.
...
public class ReqGetFollowShowInfoList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetFollowShowInfoList() {}

  /** copy constructor */
  public ReqGetFollowShowInfoList (ReqGetFollowShowInfoList arg) {
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
  }
