...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGRelevantPeople.java
//
//   Java class for ASN.1 definition GGRelevantPeople as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GGRelevantPeople</tt>.
...
public class GGRelevantPeople implements ASN1Type {

  /** member variable representing the sequence member uid of type java.math.BigInteger */
  public java.math.BigInteger uid;
  /** member variable representing the sequence member relevantlist of type RelevantPeopleInfoList */
  public RelevantPeopleInfoList relevantlist = new RelevantPeopleInfoList();
  ...
  /** default constructor */
  public GGRelevantPeople() {}

  /** copy constructor */
  public GGRelevantPeople (GGRelevantPeople arg) {
    uid = arg.uid;
    relevantlist = new RelevantPeopleInfoList(arg.relevantlist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("relevantlist = ");
    relevantlist.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
