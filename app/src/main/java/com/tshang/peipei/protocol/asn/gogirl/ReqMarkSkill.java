...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqMarkSkill.java
//
//   Java class for ASN.1 definition ReqMarkSkill as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqMarkSkill</tt>.
...
public class ReqMarkSkill implements ASN1Type {
  ...
  /** copy constructor */
  public ReqMarkSkill (ReqMarkSkill arg) {
    selfuid = arg.selfuid;
    peeruid = arg.peeruid;
    skillid = arg.skillid;
    point = arg.point;
