...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqDeliverGift.java
//
//   Java class for ASN.1 definition ReqDeliverGift as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqDeliverGift</tt>.
...
public class ReqDeliverGift implements ASN1Type {
  ...
  /** default constructor */
  public ReqDeliverGift() {}

  /** copy constructor */
  public ReqDeliverGift (ReqDeliverGift arg) {
    fromuid = arg.fromuid;
    touid = arg.touid;
    giftid = arg.giftid;
    giftnum = arg.giftnum;
