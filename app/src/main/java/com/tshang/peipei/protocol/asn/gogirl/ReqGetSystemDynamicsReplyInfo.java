...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetSystemDynamicsReplyInfo.java
//
//   Java class for ASN.1 definition ReqGetSystemDynamicsReplyInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetSystemDynamicsReplyInfo</tt>.
...
public class ReqGetSystemDynamicsReplyInfo implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetSystemDynamicsReplyInfo() {}

  /** copy constructor */
  public ReqGetSystemDynamicsReplyInfo (ReqGetSystemDynamicsReplyInfo arg) {
    uid = arg.uid;
    type = arg.type;
    topicid = arg.topicid;
    start = arg.start;
