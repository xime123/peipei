...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetAlbumInfo.java
//
//   Java class for ASN.1 definition ReqGetAlbumInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetAlbumInfo</tt>.
...
public class ReqGetAlbumInfo implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetAlbumInfo() {}

  /** copy constructor */
  public ReqGetAlbumInfo (ReqGetAlbumInfo arg) {
    selfuid = arg.selfuid;
    uid = arg.uid;
    albumid = arg.albumid;
  }
