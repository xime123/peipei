...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetUseAnonymNickInfo.java
//
//   Java class for ASN.1 definition ReqGetUseAnonymNickInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetUseAnonymNickInfo</tt>.
...
public class ReqGetUseAnonymNickInfo implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetUseAnonymNickInfo() {}

  /** copy constructor */
  public ReqGetUseAnonymNickInfo (ReqGetUseAnonymNickInfo arg) {
    id = arg.id;
    uid = arg.uid;
  }
