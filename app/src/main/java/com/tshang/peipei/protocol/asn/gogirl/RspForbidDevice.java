...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspForbidDevice.java
//
//   Java class for ASN.1 definition RspForbidDevice as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspForbidDevice</tt>.
...
public class RspForbidDevice implements ASN1Type {
  ...
  /** member variable representing the sequence member deviceid of type byte[] */
  public byte[] deviceid;

  /** default constructor */
  public RspForbidDevice() {}

  /** copy constructor */
  public RspForbidDevice (RspForbidDevice arg) {
    retcode = arg.retcode;
    retmsg = new byte[arg.retmsg.length];
    System.arraycopy(arg.retmsg,0,retmsg,0,arg.retmsg.length);
    uid = arg.uid;
    deviceid = new byte[arg.deviceid.length];
    System.arraycopy(arg.deviceid,0,deviceid,0,arg.deviceid.length);
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeOctetString(deviceid);
    enc.endOf(seq_nr);
  }
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    deviceid = dec.decodeOctetString();
    dec.endOf(seq_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("deviceid = ");
    os.print(Hex.toString(deviceid));
    os.println();
