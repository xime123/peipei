...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/TruthInfo.java
//
//   Java class for ASN.1 definition TruthInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>TruthInfo</tt>.
...
public class TruthInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member questionid of type java.math.BigInteger */
  public java.math.BigInteger questionid;
  /** member variable representing the sequence member strquestion of type byte[] */
  public byte[] strquestion;
  /** member variable representing the sequence member answerlist of type TruthAnswerList */
  public TruthAnswerList answerlist = new TruthAnswerList();
  ...
  /** member variable representing the sequence member fromanswer of type java.math.BigInteger */
  public java.math.BigInteger fromanswer;
  /** member variable representing the sequence member toanswer of type java.math.BigInteger */
  public java.math.BigInteger toanswer;
  ...
  /** copy constructor */
  public TruthInfo (TruthInfo arg) {
    truthid = new byte[arg.truthid.length];
    System.arraycopy(arg.truthid,0,truthid,0,arg.truthid.length);
    fromuid = arg.fromuid;
    touid = arg.touid;
    questionid = arg.questionid;
    strquestion = new byte[arg.strquestion.length];
    System.arraycopy(arg.strquestion,0,strquestion,0,arg.strquestion.length);
    answerlist = new TruthAnswerList(arg.answerlist);
    createtime = arg.createtime;
    fromanswer = arg.fromanswer;
    toanswer = arg.toanswer;
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(questionid);
    enc.encodeOctetString(strquestion);
    answerlist.encode(enc);
    enc.encodeInteger(createtime);
    enc.encodeInteger(fromanswer);
    enc.encodeInteger(toanswer);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    questionid = dec.decodeInteger();
    strquestion = dec.decodeOctetString();
    answerlist.decode(dec);
    createtime = dec.decodeInteger();
    fromanswer = dec.decodeInteger();
    toanswer = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("questionid = ");
    os.print(questionid.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("strquestion = ");
    os.print(Hex.toString(strquestion));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("answerlist = ");
    answerlist.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("createtime = ");
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("fromanswer = ");
    os.print(fromanswer.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("toanswer = ");
    os.print(toanswer.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
