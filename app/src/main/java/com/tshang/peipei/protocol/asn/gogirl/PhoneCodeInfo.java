...
//
//   File: ./src/com/tshang/peipei/asn/gogirl/PhoneCodeInfo.java
//
//   Java class for ASN.1 definition PhoneCodeInfo as defined in
//   module GOGIRL.
//   This file was generated by Snacc for Java at Mon Nov 17 20:14:06 2014
//-----------------------------------------------------------------------------
...
/** This class represents the ASN.1 SEQUENCE type <tt>PhoneCodeInfo</tt>.
  * For each sequence member, sequence classes contain a
  * public member variable of the corresponding Java type.
  * @author Snacc for Java
  * @version Mon Nov 17 20:14:05 2014

  */

public class PhoneCodeInfo implements ASN1Type {
  ...
  public byte[] code;
  /** member variable representing the sequence member lastgettime of type java.math.BigInteger */
  public java.math.BigInteger lastgettime;
  /** member variable representing the sequence member gettimes of type java.math.BigInteger */
  public java.math.BigInteger gettimes;
  ...
  /** copy constructor */
  public PhoneCodeInfo (PhoneCodeInfo arg) {
    ...
    lastgettime = arg.lastgettime;
    gettimes = arg.gettimes;
    status = arg.status;
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(lastgettime);
    enc.encodeInteger(gettimes);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    lastgettime = dec.decodeInteger();
    gettimes = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("lastgettime = ");
    os.print(lastgettime.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("gettimes = ");
    os.print(gettimes.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("status = ");
