...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGConfInfoList.java
//
//   Java class for ASN.1 definition GGConfInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>GGConfInfoList</tt>.
...
public class GGConfInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public GGConfInfoList() {}

  /** copy constructor */
  public GGConfInfoList (GGConfInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((GGConfInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((GGConfInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((GGConfInfo)(e.nextElement())).print(os, indent+2);
