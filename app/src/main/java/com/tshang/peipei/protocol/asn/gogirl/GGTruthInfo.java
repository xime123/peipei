...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGTruthInfo.java
//
//   Java class for ASN.1 definition GGTruthInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GGTruthInfo</tt>.
...
public class GGTruthInfo implements ASN1Type {

  /** member variable representing the sequence member place of type java.math.BigInteger */
  public java.math.BigInteger place;
  /** member variable representing the sequence member curid of type java.math.BigInteger */
  public java.math.BigInteger curid;
  /** member variable representing the sequence member truthlist of type TruthInfoList */
  public TruthInfoList truthlist = new TruthInfoList();
  ...
  /** copy constructor */
  public GGTruthInfo (GGTruthInfo arg) {
    place = arg.place;
    curid = arg.curid;
    truthlist = new TruthInfoList(arg.truthlist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(place);
    enc.encodeInteger(curid);
    truthlist.encode(enc);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    place = dec.decodeInteger();
    curid = dec.decodeInteger();
    truthlist.decode(dec);
