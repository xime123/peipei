...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetTopicDetail.java
//
//   Java class for ASN.1 definition ReqGetTopicDetail as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetTopicDetail</tt>.
...
public class ReqGetTopicDetail implements ASN1Type {
  ...
  /** member variable representing the sequence member isgettopic of type java.math.BigInteger */
  public java.math.BigInteger isgettopic;
  ...
  /** default constructor */
  public ReqGetTopicDetail() {}

  /** copy constructor */
  public ReqGetTopicDetail (ReqGetTopicDetail arg) {
    uid = arg.uid;
    topicuid = arg.topicuid;
    topicid = arg.topicid;
    isgettopic = arg.isgettopic;
    start = arg.start;
    num = arg.num;
  }
