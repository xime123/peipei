...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetSmileConf.java
//
//   Java class for ASN.1 definition ReqGetSmileConf as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetSmileConf</tt>.
...
public class ReqGetSmileConf implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetSmileConf() {}

  /** copy constructor */
  public ReqGetSmileConf (ReqGetSmileConf arg) {
    uid = arg.uid;
    appver = arg.appver;
    fromos = arg.fromos;
    confver = arg.confver;
