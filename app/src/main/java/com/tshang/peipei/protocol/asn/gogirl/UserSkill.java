...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/UserSkill.java
//
//   Java class for ASN.1 definition UserSkill as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>UserSkill</tt>.
...
public class UserSkill implements ASN1Type {
  ...
  /** member variable representing the sequence member skilllist of type GGSkillInfoList */
  public GGSkillInfoList skilllist = new GGSkillInfoList();
  ...
  /** copy constructor */
  public UserSkill (UserSkill arg) {
    uid = arg.uid;
    curid = arg.curid;
    skilllist = new GGSkillInfoList(arg.skilllist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
