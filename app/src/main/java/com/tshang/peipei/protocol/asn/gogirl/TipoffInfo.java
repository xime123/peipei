...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/TipoffInfo.java
//
//   Java class for ASN.1 definition TipoffInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>TipoffInfo</tt>.
...
public class TipoffInfo implements ASN1Type {

  /** member variable representing the sequence member id of type java.math.BigInteger */
  public java.math.BigInteger id;
  /** member variable representing the sequence member reasons of type TipoffReasonList */
  public TipoffReasonList reasons = new TipoffReasonList();
  ...
  /** member variable representing the sequence member tipoffnum of type java.math.BigInteger */
  public java.math.BigInteger tipoffnum;
  /** member variable representing the sequence member tipoffskillid of type java.math.BigInteger */
  public java.math.BigInteger tipoffskillid;
  ...
  /** copy constructor */
  public TipoffInfo (TipoffInfo arg) {
    id = arg.id;
    reasons = new TipoffReasonList(arg.reasons);
    tipoffuid = arg.tipoffuid;
    tipofftopicid = arg.tipofftopicid;
    tipoffcommentid = arg.tipoffcommentid;
    tipoffreplyid = arg.tipoffreplyid;
    tipoffnum = arg.tipoffnum;
    tipoffskillid = arg.tipoffskillid;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
    revint4 = arg.revint4;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(tipoffnum);
    enc.encodeInteger(tipoffskillid);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    tipoffnum = dec.decodeInteger();
    tipoffskillid = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("tipoffnum = ");
    os.print(tipoffnum.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("tipoffskillid = ");
    os.print(tipoffskillid.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint1 = ");
