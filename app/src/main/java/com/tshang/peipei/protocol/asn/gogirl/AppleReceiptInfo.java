...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/AppleReceiptInfo.java
//
//   Java class for ASN.1 definition AppleReceiptInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>AppleReceiptInfo</tt>.
...
public class AppleReceiptInfo implements ASN1Type {

  /** member variable representing the sequence member id of type java.math.BigInteger */
  public java.math.BigInteger id;
  /** member variable representing the sequence member foruid of type java.math.BigInteger */
  public java.math.BigInteger foruid;
  /** member variable representing the sequence member transactionid of type byte[] */
  public byte[] transactionid;
  /** member variable representing the sequence member receipt of type byte[] */
  public byte[] receipt;
  ...
  /** default constructor */
  public AppleReceiptInfo() {}

  /** copy constructor */
  public AppleReceiptInfo (AppleReceiptInfo arg) {
    id = arg.id;
    foruid = arg.foruid;
    ...
    receipt = new byte[arg.receipt.length];
    System.arraycopy(arg.receipt,0,receipt,0,arg.receipt.length);
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(foruid);
    enc.encodeOctetString(transactionid);
    enc.encodeOctetString(receipt);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    foruid = dec.decodeInteger();
    transactionid = dec.decodeOctetString();
    receipt = dec.decodeOctetString();
