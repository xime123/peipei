...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetGroupMemberList.java
//
//   Java class for ASN.1 definition ReqGetGroupMemberList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetGroupMemberList</tt>.
...
public class ReqGetGroupMemberList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetGroupMemberList() {}

  /** copy constructor */
  public ReqGetGroupMemberList (ReqGetGroupMemberList arg) {
    selfuid = arg.selfuid;
    groupid = arg.groupid;
    start = arg.start;
    num = arg.num;
