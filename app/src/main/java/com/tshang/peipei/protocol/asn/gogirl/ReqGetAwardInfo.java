...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetAwardInfo.java
//
//   Java class for ASN.1 definition ReqGetAwardInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetAwardInfo</tt>.
...
public class ReqGetAwardInfo implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetAwardInfo() {}

  /** copy constructor */
  public ReqGetAwardInfo (ReqGetAwardInfo arg) {
    type = arg.type;
    uid = arg.uid;
  }
