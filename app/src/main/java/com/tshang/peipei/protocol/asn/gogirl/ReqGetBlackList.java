...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetBlackList.java
//
//   Java class for ASN.1 definition ReqGetBlackList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetBlackList</tt>.
...
public class ReqGetBlackList implements ASN1Type {
  ...
  /** copy constructor */
  public ReqGetBlackList (ReqGetBlackList arg) {
    selfuid = arg.selfuid;
    hostuid = arg.hostuid;
    start = arg.start;
    num = arg.num;
