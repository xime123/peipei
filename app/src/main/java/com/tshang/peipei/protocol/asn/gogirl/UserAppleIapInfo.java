...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/UserAppleIapInfo.java
//
//   Java class for ASN.1 definition UserAppleIapInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>UserAppleIapInfo</tt>.
...
public class UserAppleIapInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member applereceiptlist of type AppleReceiptInfoList */
  public AppleReceiptInfoList applereceiptlist = new AppleReceiptInfoList();
  ...
  /** default constructor */
  public UserAppleIapInfo() {}

  /** copy constructor */
  public UserAppleIapInfo (UserAppleIapInfo arg) {
    uid = arg.uid;
    curid = arg.curid;
    applereceiptlist = new AppleReceiptInfoList(arg.applereceiptlist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("applereceiptlist = ");
    applereceiptlist.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
