...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqDelFingerGuessing.java
//
//   Java class for ASN.1 definition ReqDelFingerGuessing as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqDelFingerGuessing</tt>.
...
public class ReqDelFingerGuessing implements ASN1Type {

  /** member variable representing the sequence member guessingstrid of type byte[] */
  public byte[] guessingstrid;

  /** default constructor */
  public ReqDelFingerGuessing() {}

  /** copy constructor */
  public ReqDelFingerGuessing (ReqDelFingerGuessing arg) {
