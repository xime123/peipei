...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqGetFansList.java
//
//   Java class for ASN.1 definition ReqGetFansList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqGetFansList</tt>.
...
public class ReqGetFansList implements ASN1Type {
  ...
  /** default constructor */
  public ReqGetFansList() {}

  /** copy constructor */
  public ReqGetFansList (ReqGetFansList arg) {
    uid = arg.uid;
    start = arg.start;
    num = arg.num;
  }
