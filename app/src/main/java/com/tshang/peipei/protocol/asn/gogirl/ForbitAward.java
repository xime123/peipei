...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ForbitAward.java
//
//   Java class for ASN.1 definition ForbitAward as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ForbitAward</tt>.
...
public class ForbitAward implements ASN1Type {
  ...
  /** member variable representing the sequence member forbittype of type java.math.BigInteger */
  public java.math.BigInteger forbittype;
  /** member variable representing the sequence member forbitpublictionvalidtime of type java.math.BigInteger */
  public java.math.BigInteger forbitpublictionvalidtime;
  ...
  /** member variable representing the sequence member forbitparticipatevalidtime of type java.math.BigInteger */
  public java.math.BigInteger forbitparticipatevalidtime;
  ...
  /** copy constructor */
  public ForbitAward (ForbitAward arg) {
    id = arg.id;
    uid = arg.uid;
    forbittype = arg.forbittype;
    forbitpublictionvalidtime = arg.forbitpublictionvalidtime;
    forbitpublictiontime = arg.forbitpublictiontime;
    forbitparticipatevalidtime = arg.forbitparticipatevalidtime;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(forbittype);
    enc.encodeInteger(forbitpublictionvalidtime);
    enc.encodeInteger(forbitpublictiontime);
    enc.encodeInteger(forbitparticipatevalidtime);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    forbittype = dec.decodeInteger();
    forbitpublictionvalidtime = dec.decodeInteger();
    forbitpublictiontime = dec.decodeInteger();
    forbitparticipatevalidtime = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("forbittype = ");
    os.print(forbittype.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("forbitpublictionvalidtime = ");
    os.print(forbitpublictionvalidtime.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("forbitparticipatevalidtime = ");
    os.print(forbitparticipatevalidtime.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
