...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ColorOptList.java
//
//   Java class for ASN.1 definition ColorOptList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>ColorOptList</tt>.
...
public class ColorOptList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public ColorOptList() {}

  /** copy constructor */
  public ColorOptList (ColorOptList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((ColorOpt)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((ColorOpt)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((ColorOpt)(e.nextElement())).print(os, indent+2);
