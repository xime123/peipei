...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/RspGetGroupInfo.java
//
//   Java class for ASN.1 definition RspGetGroupInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>RspGetGroupInfo</tt>.
...
public class RspGetGroupInfo implements ASN1Type {
  ...
  public byte[] retmsg;
  /** member variable representing the sequence member groupinfo of type GroupInfo */
  public GroupInfo groupinfo = new GroupInfo();

  /** default constructor */
  public RspGetGroupInfo() {}

  /** copy constructor */
  public RspGetGroupInfo (RspGetGroupInfo arg) {
    retcode = arg.retcode;
    retmsg = new byte[arg.retmsg.length];
    System.arraycopy(arg.retmsg,0,retmsg,0,arg.retmsg.length);
    groupinfo = new GroupInfo(arg.groupinfo);
  }
