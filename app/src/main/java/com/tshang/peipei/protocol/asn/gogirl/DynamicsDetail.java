...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/DynamicsDetail.java
//
//   Java class for ASN.1 definition DynamicsDetail as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>DynamicsDetail</tt>.
...
public class DynamicsDetail implements ASN1Type {
  ...
  /** default constructor */
  public DynamicsDetail() {}

  /** copy constructor */
  public DynamicsDetail (DynamicsDetail arg) {
    id = arg.id;
    visible = arg.visible;
