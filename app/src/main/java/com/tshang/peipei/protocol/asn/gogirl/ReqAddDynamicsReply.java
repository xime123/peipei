...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/ReqAddDynamicsReply.java
//
//   Java class for ASN.1 definition ReqAddDynamicsReply as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>ReqAddDynamicsReply</tt>.
...
public class ReqAddDynamicsReply implements ASN1Type {
  ...
  /** member variable representing the sequence member systemtopicid of type java.math.BigInteger */
  public java.math.BigInteger systemtopicid;
  ...
  /** default constructor */
  public ReqAddDynamicsReply() {}

  /** copy constructor */
  public ReqAddDynamicsReply (ReqAddDynamicsReply arg) {
    type = arg.type;
    uid = arg.uid;
    topicuid = arg.topicuid;
    topicid = arg.topicid;
    systemtopicid = arg.systemtopicid;
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    enc.encodeInteger(systemtopicid);
  ...
  public void decode (ASN1Decoder dec) throws ASN1Exception {
    ...
    systemtopicid = dec.decodeInteger();
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("systemtopicid = ");
    os.print(systemtopicid.toString());
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("commentid = ");
