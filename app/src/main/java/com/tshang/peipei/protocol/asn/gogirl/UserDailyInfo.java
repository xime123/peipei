...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/UserDailyInfo.java
//
//   Java class for ASN.1 definition UserDailyInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>UserDailyInfo</tt>.
...
public class UserDailyInfo implements ASN1Type {

  /** member variable representing the sequence member uid of type java.math.BigInteger */
  public java.math.BigInteger uid;
  /** member variable representing the sequence member rewardlist of type UserRewardInfoList */
  public UserRewardInfoList rewardlist = new UserRewardInfoList();
  ...
  /** default constructor */
  public UserDailyInfo() {}

  /** copy constructor */
  public UserDailyInfo (UserDailyInfo arg) {
    uid = arg.uid;
    rewardlist = new UserRewardInfoList(arg.rewardlist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
