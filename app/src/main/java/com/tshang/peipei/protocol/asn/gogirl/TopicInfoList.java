...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/TopicInfoList.java
//
//   Java class for ASN.1 definition TopicInfoList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE OF type <tt>TopicInfoList</tt>.
...
public class TopicInfoList extends java.util.Vector implements ASN1Type {

  /** default constructor */
  public TopicInfoList() {}

  /** copy constructor */
  public TopicInfoList (TopicInfoList arg) {
    for (java.util.Enumeration e = arg.elements(); e.hasMoreElements();) {
      addElement(((TopicInfo)(e.nextElement())));
    }
  }
  ...
  public void encode (ASN1Encoder enc) throws ASN1Exception {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ((TopicInfo)(e.nextElement())).encode(enc);
    }
    enc.endOf(seq_of_nr);
  }
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      ((TopicInfo)(e.nextElement())).print(os, indent+2);
