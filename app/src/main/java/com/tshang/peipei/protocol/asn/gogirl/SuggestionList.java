...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/SuggestionList.java
//
//   Java class for ASN.1 definition SuggestionList as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>SuggestionList</tt>.
...
public class SuggestionList implements ASN1Type {
  ...
  /** member variable representing the sequence member suggestionlist of type SuggestionInfoList */
  public SuggestionInfoList suggestionlist = new SuggestionInfoList();
  ...
  /** copy constructor */
  public SuggestionList (SuggestionList arg) {
    curid = arg.curid;
    total = arg.total;
    suggestionlist = new SuggestionInfoList(arg.suggestionlist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("suggestionlist = ");
    suggestionlist.print(os, indent+2);
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("revint0 = ");
