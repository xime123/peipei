...
//
//   File: ./src/com/tshang/peipei/protocol/asn/gogirl/GGDareInfo.java
//
//   Java class for ASN.1 definition GGDareInfo as defined in
//   module GOGIRL.
...
/** This class represents the ASN.1 SEQUENCE type <tt>GGDareInfo</tt>.
...
public class GGDareInfo implements ASN1Type {
  ...
  /** member variable representing the sequence member darelist of type DareInfoList */
  public DareInfoList darelist = new DareInfoList();
  ...
  /** copy constructor */
  public GGDareInfo (GGDareInfo arg) {
    place = arg.place;
    curid = arg.curid;
    darelist = new DareInfoList(arg.darelist);
    revint0 = arg.revint0;
    revint1 = arg.revint1;
    revint2 = arg.revint2;
    revint3 = arg.revint3;
