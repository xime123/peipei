...
public class GoGirlUserInfoBuilder extends JSONBuilder<GoGirlUserInfo> {
	...
	public GoGirlUserInfo build(JSONObject jsonObject) throws JSONException {
		...
		if (!jsonObject.isNull("username")) {
			...
			userInfo.username = username.getBytes();
		}
		...
		if (!jsonObject.isNull("phonebrand")) {
			...
			userInfo.phonebrand = phonebrand.getBytes();
		}
		...
		if (!jsonObject.isNull("verifycode")) {
			...
			userInfo.verifycode = verifycode.getBytes();
		}
		...
		if (!jsonObject.isNull("mailcode")) {
			...
			userInfo.mailcode = mailcode.getBytes();
		}
		...
		if (!jsonObject.isNull("channel")) {
			...
			userInfo.channel = channel.getBytes();
		}
