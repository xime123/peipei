...
import com.tshang.peipei.model.request.RequestDelReply;
import com.tshang.peipei.model.request.RequestDelReply.IDelReplyCallBack;
 ...
 *
 */
public class DeleteReplyDialog extends Dialog implements DialogInterface.OnDismissListener, android.view.View.OnClickListener, IDelReplyCallBack {
	...
	public DeleteReplyDialog(Activity context) {
		super(context);
		this.context = context;
	}

	public DeleteReplyDialog(Activity context, int theme, int commentid, int replyid, int topicid, int uid, int topicuid, BAHandler mHandler) {
		super(context, theme);
		this.context = context;
	...
	public void onClick(View v) {
		...
		case R.id.ok_sure://去登录
			this.dismiss();
			RequestDelReply request = new RequestDelReply();
			BaseUtils.showDialog(context, context.getString(R.string.str_deleting));
			request.delReply(BAApplication.mLocalUserInfo.auth, BAApplication.app_version_code, commentid, replyid, topicid, uid, topicuid, this);
