 ...
 * @version V1.0   
 */
public class ViewSolitaireRedPacketChatItemAdapter extends ViewBaseChatItemAdapter {

	public ViewSolitaireRedPacketChatItemAdapter(Activity activity, int friendUid, int friendSex, String friendNick, boolean isGroupChate,
	...
	public View getView(int position, View convertView, ViewGroup parent, ChatDatabaseEntity chatEntity) {
		...
		if (isGroupChat) {
//			setGroupViewPading1(viewHolder.rootLayout);
