 ...
 * @version V1.0   
 */
public class TipsAdapter extends ArrayListAdapter<String> {

	public TipsAdapter(Activity context) {
		super(context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = View.inflate(mContext, R.layout.adapter_tip_item, null);
