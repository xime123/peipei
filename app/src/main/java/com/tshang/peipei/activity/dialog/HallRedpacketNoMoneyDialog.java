 ...
 * @version V1.0   
 */
public class HallRedpacketNoMoneyDialog extends Dialog implements OnDismissListener, android.view.View.OnClickListener {
	...
	public HallRedpacketNoMoneyDialog(Activity context) {
		super(context);
		this.context = context;
	}

	public HallRedpacketNoMoneyDialog(Activity context, int theme, BroadcastRedPacketInfo redpacketInfo, BAHandler mHandler) {
		super(context, theme);
		this.context = context;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog_hall_redpacket_no_money);
		...
		setListener();
		HallRedpacketNoMoneyDialog.this.setOnDismissListener(this);
	}
